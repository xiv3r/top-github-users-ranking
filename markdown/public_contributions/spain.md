...
The `public contributions` by users in Spain on `2025/10/8 8:55 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
