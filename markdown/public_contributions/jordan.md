...
The `public contributions` by users in Jordan on `2025/2/1 1:44 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
