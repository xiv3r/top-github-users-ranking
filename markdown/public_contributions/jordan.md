...
The `public contributions` by users in Jordan on `2026/8/30 7:09 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
