...
The `public contributions` by users in Jordan on `2025/10/14 1:31 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
