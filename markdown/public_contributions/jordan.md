...
The `public contributions` by users in Jordan on `2025/12/20 5:50 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
