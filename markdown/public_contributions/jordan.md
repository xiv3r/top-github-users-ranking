...
The `public contributions` by users in Jordan on `2026/7/7 11:35 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
