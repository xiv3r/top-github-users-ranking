...
The `public contributions` by users in Jordan on `2025/6/26 8:48 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
