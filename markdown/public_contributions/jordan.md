...
The `public contributions` by users in Jordan on `2025/11/29 5:24 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
