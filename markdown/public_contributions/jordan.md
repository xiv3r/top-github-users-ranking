...
The `public contributions` by users in Jordan on `2026/3/25 12:02 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
