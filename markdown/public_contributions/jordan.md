...
The `public contributions` by users in Jordan on `2025/7/10 8:32 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
