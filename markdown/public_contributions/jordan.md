...
The `public contributions` by users in Jordan on `2025/11/15 1:47 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
