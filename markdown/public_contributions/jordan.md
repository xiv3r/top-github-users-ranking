...
The `public contributions` by users in Jordan on `2026/8/2 2:14 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
