...
The `public contributions` by users in Jordan on `2024/12/30 10:27 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
