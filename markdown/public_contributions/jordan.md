...
The `public contributions` by users in Jordan on `2025/3/3 4:44 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
