...
The `public contributions` by users in Jordan on `2025/4/20 8:18 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
