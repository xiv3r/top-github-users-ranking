...
The `public contributions` by users in Jordan on `2025/4/4 8:34 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
