...
The `public contributions` by users in Jordan on `2025/5/8 8:29 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
