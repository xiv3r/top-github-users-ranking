...
The `public contributions` by users in Jordan on `2025/10/12 10:25 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
