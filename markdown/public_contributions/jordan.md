...
The `public contributions` by users in Jordan on `2025/8/18 6:35 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
