...
The `public contributions` by users in Jordan on `2026/1/8 8:42 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
