...
The `public contributions` by users in Jordan on `2025/12/9 9:32 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
