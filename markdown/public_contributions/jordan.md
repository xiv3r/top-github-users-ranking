...
The `public contributions` by users in Jordan on `2025/11/6 5:47 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
