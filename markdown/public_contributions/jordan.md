...
The `public contributions` by users in Jordan on `2025/3/27 6:00 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
