...
The `public contributions` by users in Jordan on `2025/8/15 6:07 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
