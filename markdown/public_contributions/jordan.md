...
The `public contributions` by users in Jordan on `2025/6/2 5:33 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
