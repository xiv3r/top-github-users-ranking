...
The `public contributions` by users in Jordan on `2025/6/17 10:39 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
