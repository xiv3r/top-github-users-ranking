...
The `public contributions` by users in Jordan on `2025/2/8 6:36 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
