...
The `public contributions` by users in Jordan on `2025/6/29 2:15 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
