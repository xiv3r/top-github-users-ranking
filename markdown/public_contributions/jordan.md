...
The `public contributions` by users in Jordan on `2025/12/31 9:08 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
