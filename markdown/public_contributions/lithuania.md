...
The `public contributions` by users in Lithuania on `2025/12/7 11:00 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
