...
The `public contributions` by users in Azerbaijan on `2025/6/8 2:21 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
