...
The `public contributions` by users in Azerbaijan on `2025/1/20 11:30 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
