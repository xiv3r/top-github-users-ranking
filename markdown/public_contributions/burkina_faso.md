...
The `public contributions` by users in Burkina Faso on `2026/4/10 1:58 PM UTC`. This list contains users from `Burkina Faso` and cities `Ouagadougou` `Bobo-dioulasso` `Koudougou` `Banfora` `Ouahigouya`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `520 users`  in Burkina Faso. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Sera3829">
				<img src="https://avatars.githubusercontent.com/u/216152447?s=72&v=4" width="24" alt="Avatar of Sera3829"> Sera3829
			</a><br/>
			Séraphin KABORE
		</td>
		<td>No Company</td>
