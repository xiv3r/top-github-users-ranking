...
The `public contributions` by users in Belgium on `2024/12/30 8:00 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
