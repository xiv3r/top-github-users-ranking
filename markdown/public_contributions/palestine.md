...
The `public contributions` by users in Palestine on `2025/5/26 11:04 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/z4dev">
				<img src="https://avatars.githubusercontent.com/u/77536501?s=72&v=4" width="24" alt="Avatar of z4dev"> z4dev
			</a><br/>
			Izzedeen Alfarra
		</td>
		<td>No Company</td>
