...
The `public contributions` by users in Slovenia on `2025/10/15 9:00 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
