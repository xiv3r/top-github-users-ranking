...
The `public contributions` by users in Ecuador on `2025/3/7 10:38 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
...
<table>
	...
	<tr>
		...
		<td>Anna.money </td>
		<td>No Twitter Username</td>
		<td>San Gregorio de Portoviejo, Ecuador</td>
		<td>80</td>
	</tr>
	<tr>
		<td>238</td>
