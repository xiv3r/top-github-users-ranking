...
The `public contributions` by users in South Africa on `2025/5/6 9:47 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
...
<table>
	...
	<tr>
		...
		<td>Software Engineer @ Vat<br/>It<br/>Compliance<br/></td>
		<td>No Twitter Username</td>
		<td>Cape Town, South Africa</td>
		<td>994</td>
	</tr>
