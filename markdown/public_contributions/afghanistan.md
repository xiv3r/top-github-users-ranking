...
The `public contributions` by users in Afghanistan on `2025/4/21 9:50 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `917 users`  in Afghanistan. You need at least `1 followers` to be on this list.
