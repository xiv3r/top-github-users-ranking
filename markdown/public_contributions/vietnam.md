...
The `public contributions` by users in Vietnam on `2025/7/25 9:57 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `943 users`  in Vietnam. You need at least `38 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Awesomepeople: @imverrydeluluu, @oceanasterism, @5uguru,<br/>&<br/>@valleysheep<-very<br/>Fluffy<br/>To<br/>Cuddle<br/>With<br/>:3<br/>&<br/>People<br/>I<br/>Followed<br/>Is<br/>Also<br/>Awesome<br/>Stunning!<br/></td>
		<td>No Twitter Username</td>
		<td>Safe server & Vietnam server (Mostly on Vietnam ser.) </td>
		<td>2</td>
	</tr>
	<tr>
		<td>734</td>
