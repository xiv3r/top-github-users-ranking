...
The `public contributions` by users in Montenegro on `2026/7/22 4:51 AM UTC`. This list contains users from `Montenegro` and cities `Podgorica` `Nikšić`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `920 users`  in Montenegro. You need at least `1 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/uxuimedia">
				<img src="https://avatars.githubusercontent.com/u/8505312?s=72&v=4" width="24" alt="Avatar of uxuimedia"> uxuimedia
			</a><br/>
			Sergei Ermilov
		</td>
		<td>No Company</td>
