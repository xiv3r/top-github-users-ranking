...
The `public contributions` by users in Burundi on `2026/3/13 9:10 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `602 users`  in Burundi. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>290</td>
		<td>
			<a href="https://github.com/floribertbiwep-design">
				<img src="https://avatars.githubusercontent.com/u/267252635?s=72&v=4" width="24" alt="Avatar of floribertbiwep-design"> floribertbiwep-design
			</a><br/>
