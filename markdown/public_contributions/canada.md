...
The `public contributions` by users in Canada on `2025/5/21 11:23 AM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
...
<table>
	...
	<tr>
		...
		<td>@superbadmario @imperiumroma @kawaiiangeloverdose @hanpilled<br/>@jackasshunt<br/></td>
		<td>No Twitter Username</td>
