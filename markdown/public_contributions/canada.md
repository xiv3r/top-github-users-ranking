...
The `public contributions` by users in Canada on `2025/5/3 10:56 AM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `929 users`  in Canada. You need at least `229 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>@superbadmario A Loser.. Mysterious<br/>Liquid<br/>@imperiumroma<br/>Another<br/>Loser<br/>@kawaiiangeloverdose<br/></td>
		<td>No Twitter Username</td>
