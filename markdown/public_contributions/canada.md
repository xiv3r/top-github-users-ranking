...
The `public contributions` by users in Canada on `2025/7/9 4:25 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/gregbell">
				<img src="https://avatars.githubusercontent.com/u/719?s=72&u=f3883b43b334cba0c0f8beba2f67b2b7ea645175&v=4" width="24" alt="Avatar of gregbell"> gregbell
			</a><br/>
			Greg Bell
		</td>
