...
The `public contributions` by users in Canada on `2025/4/11 3:38 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `932 users`  in Canada. You need at least `226 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>@textileio @tablelandnetwork @recallnet </td>
