...
The `public contributions` by users in Finland on `2026/1/20 10:43 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
