...
The `public contributions` by users in Finland on `2025/9/17 10:51 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
