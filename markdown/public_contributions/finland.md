...
The `public contributions` by users in Finland on `2025/10/3 1:57 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
