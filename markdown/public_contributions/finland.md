...
The `public contributions` by users in Finland on `2025/12/20 10:21 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
