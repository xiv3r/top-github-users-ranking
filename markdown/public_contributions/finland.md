...
The `public contributions` by users in Finland on `2025/2/18 9:40 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
