...
The `public contributions` by users in Finland on `2025/11/12 8:40 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
