...
The `public contributions` by users in Finland on `2025/11/10 9:10 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
