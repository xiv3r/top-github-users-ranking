...
The `public contributions` by users in Finland on `2025/1/1 1:35 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
