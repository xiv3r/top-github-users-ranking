...
The `public contributions` by users in Finland on `2025/6/9 12:01 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
