...
The `public contributions` by users in Finland on `2025/10/16 11:35 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
