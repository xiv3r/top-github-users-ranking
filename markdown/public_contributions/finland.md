...
The `public contributions` by users in Finland on `2025/12/14 5:54 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
