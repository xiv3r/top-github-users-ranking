...
The `public contributions` by users in Finland on `2025/2/27 9:23 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
