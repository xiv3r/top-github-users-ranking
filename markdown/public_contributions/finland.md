...
The `public contributions` by users in Finland on `2025/8/20 10:57 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
