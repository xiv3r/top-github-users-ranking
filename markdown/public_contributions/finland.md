...
The `public contributions` by users in Finland on `2025/10/23 4:54 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
