...
The `public contributions` by users in Finland on `2025/8/30 5:59 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
