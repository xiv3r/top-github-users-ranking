...
The `public contributions` by users in Finland on `2025/5/1 9:27 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
