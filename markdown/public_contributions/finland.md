...
The `public contributions` by users in Finland on `2025/1/5 8:48 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
