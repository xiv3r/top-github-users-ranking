...
The `public contributions` by users in Finland on `2025/6/2 10:05 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
