...
The `public contributions` by users in Finland on `2025/7/30 1:59 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
