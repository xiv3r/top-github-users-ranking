...
The `public contributions` by users in Finland on `2025/4/3 11:29 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
