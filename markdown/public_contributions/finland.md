...
The `public contributions` by users in Finland on `2025/7/24 12:20 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
