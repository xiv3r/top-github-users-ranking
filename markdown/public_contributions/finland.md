...
The `public contributions` by users in Finland on `2026/2/18 1:58 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
