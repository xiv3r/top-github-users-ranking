...
The `public contributions` by users in Finland on `2025/1/30 1:01 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
