...
The `public contributions` by users in Finland on `2025/9/24 8:44 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
