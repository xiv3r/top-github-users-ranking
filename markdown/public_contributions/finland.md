...
The `public contributions` by users in Finland on `2025/4/5 7:47 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
