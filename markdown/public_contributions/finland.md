...
The `public contributions` by users in Finland on `2025/12/25 3:37 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
