...
The `public contributions` by users in Finland on `2026/1/14 6:00 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
