...
The `public contributions` by users in Finland on `2025/10/9 10:41 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
