...
The `public contributions` by users in Finland on `2025/11/19 10:02 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
