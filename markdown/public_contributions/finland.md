...
The `public contributions` by users in Finland on `2026/9/19 11:29 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
