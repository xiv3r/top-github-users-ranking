...
The `public contributions` by users in Romania on `2025/3/24 11:45 AM UTC`. This list contains users from `Romania` and cities `Bucharest` `Constanța`.
...
<table>
	...
	<tr>
		<td>626</td>
		<td>
			<a href="https://github.com/deodre">
				<img src="https://avatars.githubusercontent.com/u/45459027?s=72&v=4" width="24" alt="Avatar of deodre"> deodre
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
