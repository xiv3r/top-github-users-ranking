...
The `public contributions` by users in Romania on `2026/3/9 10:04 PM UTC`. This list contains users from `Romania` and cities `Bucharest` `Constanța`.
...
<table>
	...
	<tr>
		...
		<td>Software Engineer @ Google<br/><br/></td>
		<td>No Twitter Username</td>
