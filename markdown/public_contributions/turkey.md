...
The `public contributions` by users in Turkey on `2025/1/16 9:00 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
