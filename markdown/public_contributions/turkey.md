...
The `public contributions` by users in Turkey on `2025/6/1 1:27 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
