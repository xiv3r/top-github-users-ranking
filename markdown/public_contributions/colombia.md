...
The `public contributions` by users in Colombia on `2025/10/13 11:25 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
