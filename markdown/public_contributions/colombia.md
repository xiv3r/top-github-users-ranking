...
The `public contributions` by users in Colombia on `2025/11/12 3:10 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
