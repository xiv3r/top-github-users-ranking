...
The `public contributions` by users in Madagascar on `2025/1/27 5:21 AM UTC`. This list contains users from `Madagascar` and cities `Antananarivo` `Toamasina` `Mahajanga` `Antsirabe`.
...
<table>
	...
	<tr>
		...
		<td>Haute Ecole D'informatique (hei)<br/>-<br/>Faculté<br/>Des<br/>Sciences<br/>(université<br/>D'antananarivo)<br/></td>
		<td>No Twitter Username</td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/JoharyManantena">
				<img src="https://avatars.githubusercontent.com/u/166318905?s=72&u=322b6930ada7bebbe9e419353578efb518e0241e&v=4" width="24" alt="Avatar of JoharyManantena"> JoharyManantena
			</a><br/>
			Johary Manantena
		</td>
		<td>No Company</td>
