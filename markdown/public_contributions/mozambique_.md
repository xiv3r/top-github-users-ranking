...
The `public contributions` by users in Mozambique  on `2025/5/29 7:45 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/thegeekoh">thegeekoh</a></td>
		<td>Maputo, Mozambique</td>
		<td>314</td>
	</tr>
	<tr>
	...
	<tr>
		<td>120</td>
		<td>
			<a href="https://github.com/Armenio-Aguiar">
				<img src="https://avatars.githubusercontent.com/u/174491130?s=72&v=4" width="24" alt="Avatar of Armenio-Aguiar"> Armenio-Aguiar
			</a><br/>
