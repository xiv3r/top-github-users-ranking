...
The `public contributions` by users in Mozambique  on `2025/12/18 1:09 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
...
<table>
	...
	<tr>
		<td>442</td>
		<td>
			<a href="https://github.com/movaagro">
				<img src="https://avatars.githubusercontent.com/u/247221524?s=72&v=4" width="24" alt="Avatar of movaagro"> movaagro
			</a><br/>
			Jose Emilio
		</td>
		<td>Mova Agro </td>
