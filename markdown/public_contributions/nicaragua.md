...
The `public contributions` by users in Nicaragua on `2025/1/23 5:28 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/barquerodev">barquerodev</a></td>
		<td>Managua, Nicaragua.</td>
		<td>18</td>
	</tr>
	<tr>
