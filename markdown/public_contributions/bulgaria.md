...
The `public contributions` by users in Bulgaria on `2025/1/20 2:58 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
