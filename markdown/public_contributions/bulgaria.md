...
The `public contributions` by users in Bulgaria on `2025/9/26 7:11 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
