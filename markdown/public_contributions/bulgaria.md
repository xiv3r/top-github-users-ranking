...
The `public contributions` by users in Bulgaria on `2025/3/30 6:46 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
