...
The `public contributions` by users in Bulgaria on `2025/3/14 4:59 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
