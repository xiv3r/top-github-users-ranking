...
The `public contributions` by users in Bulgaria on `2025/2/13 9:57 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
