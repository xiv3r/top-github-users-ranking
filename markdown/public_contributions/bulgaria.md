...
The `public contributions` by users in Bulgaria on `2025/2/25 5:17 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
