...
The `public contributions` by users in Bulgaria on `2025/10/24 10:30 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
