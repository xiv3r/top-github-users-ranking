...
The `public contributions` by users in Bulgaria on `2025/7/26 5:27 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
