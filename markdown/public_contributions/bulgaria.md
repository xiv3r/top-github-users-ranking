...
The `public contributions` by users in Bulgaria on `2025/8/8 4:10 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
