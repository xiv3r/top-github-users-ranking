...
The `public contributions` by users in Bulgaria on `2025/12/19 10:58 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
