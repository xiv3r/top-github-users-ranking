...
The `public contributions` by users in Bulgaria on `2025/2/2 4:25 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
