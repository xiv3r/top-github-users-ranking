...
The `public contributions` by users in Bulgaria on `2025/7/17 2:21 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
