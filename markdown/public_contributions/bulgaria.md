...
The `public contributions` by users in Bulgaria on `2025/8/27 7:54 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
