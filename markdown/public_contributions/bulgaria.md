...
The `public contributions` by users in Bulgaria on `2025/9/22 4:02 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
