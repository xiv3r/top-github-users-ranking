...
The `public contributions` by users in Bulgaria on `2025/5/30 2:33 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
