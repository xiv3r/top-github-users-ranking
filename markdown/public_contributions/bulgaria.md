...
The `public contributions` by users in Bulgaria on `2025/4/26 2:50 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
