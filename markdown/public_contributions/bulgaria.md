...
The `public contributions` by users in Bulgaria on `2026/1/13 4:59 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
