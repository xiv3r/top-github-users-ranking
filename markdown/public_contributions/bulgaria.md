...
The `public contributions` by users in Bulgaria on `2025/12/14 9:41 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
