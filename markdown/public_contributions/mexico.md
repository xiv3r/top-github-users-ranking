...
The `public contributions` by users in Mexico on `2025/4/12 9:06 AM UTC`. This list contains users from `Mexico` and cities `Mexico-city` `Guadalajara` `Puebla` `Ciudad-juárez` `Tijuana` `Monterrey` `Mexicali`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `964 users`  in Mexico. You need at least `36 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/porto-o">
				<img src="https://avatars.githubusercontent.com/u/57170000?s=72&u=fdcaef69f95081c98482a4c9feba538c3efe9518&v=4" width="24" alt="Avatar of porto-o"> porto-o
			</a><br/>
			Ismael Porto
		</td>
		<td>No Company</td>
