...
The `public contributions` by users in Mexico on `2025/3/7 10:03 PM UTC`. This list contains users from `Mexico` and cities `Mexico-city` `Guadalajara` `Puebla` `Ciudad-juárez` `Tijuana` `Monterrey` `Mexicali`.
...
<table>
	...
	<tr>
		<td>764</td>
		<td>
			<a href="https://github.com/AlvaroFierro">
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/alvarofierroo">alvarofierroo</a></td>
		<td>Mexico</td>
		<td>1</td>
	</tr>
</table>
