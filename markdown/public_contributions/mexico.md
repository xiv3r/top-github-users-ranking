...
The `public contributions` by users in Mexico on `2025/7/12 9:04 PM UTC`. This list contains users from `Mexico` and cities `Mexico-city` `Guadalajara` `Puebla` `Ciudad-juárez` `Tijuana` `Monterrey` `Mexicali`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/Vayioleta">Vayioleta</a></td>
		<td>Mexico</td>
		<td>6</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/rafmagana">
				<img src="https://avatars.githubusercontent.com/u/92894?s=72&u=61555665c9d5989daa8e707efc083b944a19d8f6&v=4" width="24" alt="Avatar of rafmagana"> rafmagana
			</a><br/>
			Rafael Magaña
		</td>
		<td>Incode </td>
