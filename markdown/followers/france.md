...
The `number of followers` of users in France on `2024/12/30 5:41 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
...
<table>
	...
	<tr>
		<td>821</td>
		<td>
			<a href="https://github.com/whopperburger">
