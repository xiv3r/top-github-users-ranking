...
The `number of followers` of users in Belgium on `2025/5/23 5:55 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
