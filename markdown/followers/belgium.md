...
The `number of followers` of users in Belgium on `2026/7/28 9:46 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		<td>900</td>
		<td>
			<a href="https://github.com/moghadas76">
	...
	<tr>
		<td>928</td>
		<td>
			<a href="https://github.com/bvandewalle">
		...
		<td>@figma </td>
		<td><a href="https://twitter.com/bvandewa">bvandewa</a></td>
