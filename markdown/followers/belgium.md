...
The `number of followers` of users in Belgium on `2025/4/24 2:54 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `946 users`  in Belgium. You need at least `45 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>782</td>
		<td>
			<a href="https://github.com/kayleigh-page">
		...
		<td><a href="https://twitter.com/kayleigh_page_">kayleigh_page_</a></td>
		<td>Antwerp, Belgium</td>
		<td>53</td>
	</tr>
	<tr>
	...
	<tr>
		<td>928</td>
		<td>
			<a href="https://github.com/francoismassart">
				<img src="https://avatars.githubusercontent.com/u/704026?s=72&v=4" width="24" alt="Avatar of francoismassart"> francoismassart
			</a><br/>
			Francois Massart
		</td>
		<td>Rtbf </td>
