...
The `number of followers` of users in Belgium on `2026/5/11 11:33 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		...
		<td>@warren-app  </td>
		<td><a href="https://twitter.com/klaascuvelier">klaascuvelier</a></td>
		<td>Ghent</td>
		<td>50</td>
	</tr>
</table>
