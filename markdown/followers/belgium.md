...
The `number of followers` of users in Belgium on `2025/6/30 12:10 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		<td>878</td>
		<td>
			<a href="https://github.com/romaingrx">
		...
		<td>Epfl </td>
		<td>No Twitter Username</td>
		<td>Switzerland and Belgium in ❤️‍🔥</td>
		<td>49</td>
	</tr>
	<tr>
		<td>879</td>
