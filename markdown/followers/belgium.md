...
The `number of followers` of users in Belgium on `2026/2/24 5:32 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		<td>928</td>
		<td>
			<a href="https://github.com/jasperbaes">
