...
The `number of followers` of users in Belgium on `2025/11/12 7:47 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
