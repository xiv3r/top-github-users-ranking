...
The `number of followers` of users in Belgium on `2025/9/24 10:05 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		<td>898</td>
		<td>
			<a href="https://github.com/andoludo">
