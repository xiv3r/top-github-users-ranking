...
The `number of followers` of users in Belgium on `2025/2/14 11:58 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `950 users`  in Belgium. You need at least `44 followers` to be on this list.
