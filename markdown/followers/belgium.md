...
The `number of followers` of users in Belgium on `2025/4/5 11:17 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		...
		<td>Pixel-nexus </td>
		<td><a href="https://twitter.com/frankiezafe">frankiezafe</a></td>
		<td>Brussels</td>
		<td>46</td>
	</tr>
	<tr>
