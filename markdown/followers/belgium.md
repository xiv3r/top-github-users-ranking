...
The `number of followers` of users in Belgium on `2026/3/31 10:08 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
