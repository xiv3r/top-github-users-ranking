...
The `number of followers` of users in Belgium on `2026/8/17 10:14 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		<td>743</td>
		<td>
			<a href="https://github.com/LoubnaEA">
	...
	<tr>
		<td>911</td>
		<td>
			<a href="https://github.com/xjapan007">
