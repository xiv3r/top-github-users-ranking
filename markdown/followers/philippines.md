...
The `number of followers` of users in Philippines on `2025/4/19 8:22 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
