...
The `number of followers` of users in Philippines on `2025/3/13 7:03 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
