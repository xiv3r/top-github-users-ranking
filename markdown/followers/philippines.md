...
The `number of followers` of users in Philippines on `2025/7/1 9:35 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
