...
The `number of followers` of users in Philippines on `2025/8/21 5:00 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
