...
The `number of followers` of users in Philippines on `2025/9/23 8:55 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
