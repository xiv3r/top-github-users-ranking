...
The `number of followers` of users in Philippines on `2025/2/28 3:41 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
