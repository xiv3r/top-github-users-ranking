...
The `number of followers` of users in Philippines on `2025/9/15 10:58 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/bleepster">bleepster</a></td>
		<td>Philippines</td>
		<td>32</td>
	</tr>
	<tr>
