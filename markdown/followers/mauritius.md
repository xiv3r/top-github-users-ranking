...
The `number of followers` of users in Mauritius on `2025/11/20 1:10 PM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.
