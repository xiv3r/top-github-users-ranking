...
The `number of followers` of users in Taiwan on `2025/10/7 9:28 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
