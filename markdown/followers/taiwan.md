...
The `number of followers` of users in Taiwan on `2025/8/20 5:03 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ytyubox">
				<img src="https://avatars.githubusercontent.com/u/42088295?s=72&v=4" width="24" alt="Avatar of ytyubox"> ytyubox
			</a><br/>
			Tsungyu Yu
		</td>
		<td>No Company</td>
