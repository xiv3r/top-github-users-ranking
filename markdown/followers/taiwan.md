...
The `number of followers` of users in Taiwan on `2025/11/14 11:54 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
