...
The `number of followers` of users in Iran on `2025/1/1 6:18 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
