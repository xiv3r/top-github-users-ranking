...
The `number of followers` of users in Iran on `2025/1/23 6:45 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
