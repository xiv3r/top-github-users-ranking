...
The `number of followers` of users in Iran on `2025/1/7 8:06 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
