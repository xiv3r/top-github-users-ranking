...
The `number of followers` of users in Iran on `2025/2/8 4:57 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
