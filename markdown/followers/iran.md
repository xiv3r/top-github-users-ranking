...
The `number of followers` of users in Iran on `2025/2/10 8:42 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
