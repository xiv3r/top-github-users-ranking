...
The `number of followers` of users in Iran on `2025/2/3 4:21 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
