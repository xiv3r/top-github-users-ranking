...
The `number of followers` of users in Slovenia on `2025/12/26 8:48 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
