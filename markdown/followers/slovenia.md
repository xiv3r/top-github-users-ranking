...
The `number of followers` of users in Slovenia on `2025/8/10 6:47 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
