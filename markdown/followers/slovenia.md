...
The `number of followers` of users in Slovenia on `2025/7/28 11:07 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
