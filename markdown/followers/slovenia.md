...
The `number of followers` of users in Slovenia on `2025/1/14 4:04 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
