...
The `number of followers` of users in Slovenia on `2025/11/16 7:48 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
