...
The `number of followers` of users in Slovenia on `2025/3/31 11:39 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
