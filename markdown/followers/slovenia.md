...
The `number of followers` of users in Slovenia on `2025/2/16 7:01 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
