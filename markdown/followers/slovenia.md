...
The `number of followers` of users in Slovenia on `2025/11/18 3:57 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/petusr">petusr</a></td>
		<td>Slovenia</td>
		<td>55</td>
	</tr>
	<tr>
