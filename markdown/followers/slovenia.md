...
The `number of followers` of users in Slovenia on `2025/9/13 7:38 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
