...
The `number of followers` of users in Slovenia on `2025/4/8 10:42 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
