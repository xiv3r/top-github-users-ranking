...
The `number of followers` of users in Slovenia on `2026/1/6 7:49 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
