...
The `number of followers` of users in Slovenia on `2025/7/15 9:26 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
