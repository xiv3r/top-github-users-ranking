...
The `number of followers` of users in Slovenia on `2026/3/10 4:34 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
