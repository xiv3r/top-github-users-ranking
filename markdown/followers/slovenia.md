...
The `number of followers` of users in Slovenia on `2026/1/26 11:42 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
