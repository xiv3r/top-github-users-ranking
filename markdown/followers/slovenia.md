...
The `number of followers` of users in Slovenia on `2025/10/17 2:48 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
