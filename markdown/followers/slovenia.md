...
The `number of followers` of users in Slovenia on `2025/8/16 3:36 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
