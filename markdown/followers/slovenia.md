...
The `number of followers` of users in Slovenia on `2025/2/12 7:37 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
