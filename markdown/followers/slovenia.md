...
The `number of followers` of users in Slovenia on `2025/12/10 8:59 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
