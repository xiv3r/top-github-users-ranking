...
The `number of followers` of users in Slovenia on `2025/5/13 10:57 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
