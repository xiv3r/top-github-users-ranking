...
The `number of followers` of users in Switzerland on `2026/7/25 9:32 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `826 users`  in Switzerland. You need at least `109 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/artwopee">
				<img src="https://avatars.githubusercontent.com/u/247956544?s=72&v=4" width="24" alt="Avatar of artwopee"> artwopee
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
