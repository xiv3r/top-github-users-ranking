...
The `number of followers` of users in Switzerland on `2025/10/19 6:38 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `844 users`  in Switzerland. You need at least `99 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Mongodb </td>
		<td><a href="https://twitter.com/FranckPachot">FranckPachot</a></td>
		<td>Switzerland</td>
		<td>99</td>
	</tr>
	<tr>
