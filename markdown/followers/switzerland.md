...
The `number of followers` of users in Switzerland on `2025/10/6 3:56 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
