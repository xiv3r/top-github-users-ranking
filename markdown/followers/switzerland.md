...
The `number of followers` of users in Switzerland on `2025/7/8 9:25 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
...
<table>
	...
	<tr>
		<td>197</td>
		<td>
			<a href="https://github.com/mrmintos">
	...
	<tr>
		...
		<td>Foen / Collenteur Hydroconsult<br/></td>
		<td>No Twitter Username</td>
