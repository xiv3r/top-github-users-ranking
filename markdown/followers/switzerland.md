...
The `number of followers` of users in Switzerland on `2025/5/7 2:38 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
