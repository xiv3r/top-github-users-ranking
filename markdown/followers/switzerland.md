...
The `number of followers` of users in Switzerland on `2025/6/8 5:05 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
