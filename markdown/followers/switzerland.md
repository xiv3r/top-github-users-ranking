...
The `number of followers` of users in Switzerland on `2025/2/16 9:07 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
...
<table>
	...
	<tr>
		...
		<td>Robotics And Ai Institute<br/></td>
		<td>No Twitter Username</td>
		<td>Zürich (Switzerland)</td>
		<td>270</td>
	</tr>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/marekdlugos">
				<img src="https://avatars.githubusercontent.com/u/1159818?s=72&u=cdc548fdb7707323a55e677cd8d5a4e1434abc07&v=4" width="24" alt="Avatar of marekdlugos"> marekdlugos
			</a><br/>
			Marek Dlugos
		</td>
		<td>Shopify, Inc. </td>
