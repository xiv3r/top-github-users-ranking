...
The `number of followers` of users in Switzerland on `2025/4/30 7:52 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
