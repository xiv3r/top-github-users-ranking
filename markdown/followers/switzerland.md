...
The `number of followers` of users in Switzerland on `2025/1/16 7:42 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
