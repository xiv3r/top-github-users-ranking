...
The `number of followers` of users in Switzerland on `2025/5/18 3:29 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
