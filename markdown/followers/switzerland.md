...
The `number of followers` of users in Switzerland on `2025/11/18 6:52 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
