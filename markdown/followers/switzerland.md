...
The `number of followers` of users in Switzerland on `2025/3/21 4:48 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
