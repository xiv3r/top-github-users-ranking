...
The `number of followers` of users in Switzerland on `2026/1/16 1:24 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
