...
The `number of followers` of users in Switzerland on `2025/3/13 3:03 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
