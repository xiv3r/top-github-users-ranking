...
The `number of followers` of users in Switzerland on `2025/6/18 9:39 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
