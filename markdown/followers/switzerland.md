...
The `number of followers` of users in Switzerland on `2025/2/9 10:39 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
