...
The `number of followers` of users in Switzerland on `2026/1/26 3:45 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
