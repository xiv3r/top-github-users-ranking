...
The `number of followers` of users in Switzerland on `2025/3/17 7:52 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
