...
The `number of followers` of users in Switzerland on `2025/7/29 5:54 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
