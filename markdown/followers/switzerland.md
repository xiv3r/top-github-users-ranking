...
The `number of followers` of users in Switzerland on `2025/8/24 8:22 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
