...
The `number of followers` of users in Switzerland on `2025/11/30 3:05 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
