...
The `number of followers` of users in Switzerland on `2025/4/9 1:02 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
