...
The `number of followers` of users in Switzerland on `2026/1/18 9:54 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
