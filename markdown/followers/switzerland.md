...
The `number of followers` of users in Switzerland on `2025/3/8 10:06 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
