...
The `number of followers` of users in Switzerland on `2025/9/11 8:07 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
