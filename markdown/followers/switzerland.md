...
The `number of followers` of users in Switzerland on `2025/4/24 4:27 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
