...
The `number of followers` of users in Switzerland on `2025/12/3 7:58 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
