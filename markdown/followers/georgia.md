...
The `number of followers` of users in Georgia on `2025/10/16 12:00 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
