...
The `number of followers` of users in Georgia on `2025/11/17 11:05 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
