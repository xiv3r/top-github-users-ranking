...
The `number of followers` of users in El Salvador on `2025/10/12 2:09 AM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
