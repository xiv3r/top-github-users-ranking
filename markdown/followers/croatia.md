...
The `number of followers` of users in Croatia on `2025/4/28 10:13 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
