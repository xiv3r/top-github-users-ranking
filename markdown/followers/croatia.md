...
The `number of followers` of users in Croatia on `2025/11/22 4:01 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
