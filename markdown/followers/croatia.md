...
The `number of followers` of users in Croatia on `2025/10/16 7:27 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/gordankresic">gordankresic</a></td>
		<td>Zagreb, Croatia</td>
		<td>12</td>
	</tr>
	<tr>
