...
The `number of followers` of users in Croatia on `2025/6/17 11:05 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
