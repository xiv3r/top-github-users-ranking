...
The `number of followers` of users in Croatia on `2025/3/7 9:06 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
