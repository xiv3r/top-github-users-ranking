...
The `number of followers` of users in Croatia on `2025/9/26 10:47 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
