...
The `number of followers` of users in Croatia on `2025/9/12 3:55 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
