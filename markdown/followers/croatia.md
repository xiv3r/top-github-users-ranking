...
The `number of followers` of users in Croatia on `2025/12/25 11:02 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
