...
The `number of followers` of users in Croatia on `2025/1/22 8:37 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
