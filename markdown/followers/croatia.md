...
The `number of followers` of users in Croatia on `2025/7/3 5:41 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
