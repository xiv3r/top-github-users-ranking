...
The `number of followers` of users in Kazakhstan on `2025/8/6 6:03 AM UTC`. This list contains users from `Kazakhstan` and cities `Almaty` `Shymkent` `Karagandy` `Taraz` `Nursultan` `Pavlodar` `Oskemen` `Semey` `Aktobe` `Kostanay`.
...
<table>
	...
	<tr>
		...
		<td>
			...
			Фуллстэк разработчик | Django, Laravel, Nuxt.js, Next.js, Flutter
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Almaty, Kazakhstan</td>
