...
The `number of followers` of users in Kazakhstan on `2025/12/18 3:47 AM UTC`. This list contains users from `Kazakhstan` and cities `Almaty` `Shymkent` `Karagandy` `Taraz` `Nursultan` `Pavlodar` `Oskemen` `Semey` `Aktobe` `Kostanay`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `965 users`  in Kazakhstan. You need at least `11 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>950</td>
		<td>
			<a href="https://github.com/ambienthack">
				<img src="https://avatars.githubusercontent.com/u/70915?s=72&u=94f6e4e899d7f26371223a2ce6cd35edef96e6ec&v=4" width="24" alt="Avatar of ambienthack"> ambienthack
			</a><br/>
			Ambient Hack
		</td>
		<td>No Company</td>
