...
The `number of followers` of users in Tanzania on `2025/1/6 9:42 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
