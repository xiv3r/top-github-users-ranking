...
The `number of followers` of users in Tanzania on `2025/4/12 9:55 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
