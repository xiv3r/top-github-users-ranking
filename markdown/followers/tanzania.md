...
The `number of followers` of users in Tanzania on `2025/11/23 12:02 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
...
<table>
	...
	<tr>
		...
		<td>Kitana Ai </td>
		<td><a href="https://twitter.com/kinturiv">kinturiv</a></td>
		<td>Dar es salaam</td>
		<td>7</td>
	</tr>
	<tr>
