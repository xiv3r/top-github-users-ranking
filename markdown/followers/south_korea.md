...
The `number of followers` of users in South Korea on `2025/2/11 12:08 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
