...
The `number of followers` of users in South Korea on `2026/1/15 10:11 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/eastoncho">eastoncho</a></td>
		<td>Seoul, South Korea</td>
		<td>118</td>
	</tr>
	<tr>
