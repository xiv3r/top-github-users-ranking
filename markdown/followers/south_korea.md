...
The `number of followers` of users in South Korea on `2025/10/26 10:22 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>@ampersandcorp @0xinevitable + @<br/></td>
		<td>No Twitter Username</td>
		<td>Seoul, Korea</td>
		<td>154</td>
	</tr>
