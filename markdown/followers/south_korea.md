...
The `number of followers` of users in South Korea on `2025/12/13 2:26 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>@indentcorp </td>
		<td><a href="https://twitter.com/yeon_gyu_kim">yeon_gyu_kim</a></td>
		<td>Gangnam-gu, Seoul, Republic of Korea</td>
		<td>115</td>
	</tr>
	<tr>
		<td>959</td>
	...
	<tr>
		<td>964</td>
		<td>
			<a href="https://github.com/sung-silver">
