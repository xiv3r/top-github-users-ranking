...
The `number of followers` of users in South Korea on `2025/7/4 2:04 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>, W̵̛̽́̿̎̀͒͋́̒̒̿͋̑͊̔͌͝ @kakaobank </td>
		<td>No Twitter Username</td>
		<td>Seoul, Republic of Korea</td>
		<td>148</td>
	</tr>
	...
	<tr>
		<td>979</td>
		<td>
			<a href="https://github.com/hope1053">
