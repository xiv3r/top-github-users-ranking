...
The `number of followers` of users in Angola on `2026/7/1 3:00 PM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/KatakiCodes">
				<img src="https://avatars.githubusercontent.com/u/118695527?s=72&v=4" width="24" alt="Avatar of KatakiCodes"> KatakiCodes
			</a><br/>
			Nelson Dos Santos
		</td>
		<td>No Company</td>
