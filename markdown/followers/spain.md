...
The `number of followers` of users in Spain on `2025/10/2 12:05 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
