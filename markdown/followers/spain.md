...
The `number of followers` of users in Spain on `2025/11/9 8:54 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
