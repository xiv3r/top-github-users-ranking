...
The `number of followers` of users in Spain on `2025/9/30 8:47 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
