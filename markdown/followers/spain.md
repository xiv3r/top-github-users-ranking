...
The `number of followers` of users in Spain on `2025/8/13 5:08 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
