...
The `number of followers` of users in Spain on `2025/1/12 6:20 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
