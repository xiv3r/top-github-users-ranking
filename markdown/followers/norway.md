...
The `number of followers` of users in Norway on `2025/2/24 8:37 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `925 users`  in Norway. You need at least `43 followers` to be on this list.
