...
The `number of followers` of users in Norway on `2025/10/12 7:10 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
