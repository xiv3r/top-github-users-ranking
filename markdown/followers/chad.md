...
The `number of followers` of users in Chad on `2025/11/19 4:01 PM UTC`. This list contains users from `Chad` and cities `N'djamena` `Moundou` `Sarh` `Abeche`.
...
<table>
	...
	<tr>
		<td>116</td>
		<td>
			<a href="https://github.com/chirac-design">
				<img src="https://avatars.githubusercontent.com/u/67022391?s=72&v=4" width="24" alt="Avatar of chirac-design"> chirac-design
			</a><br/>
			Chirac DJAKBA DJAMO
		</td>
		<td>Doing </td>
