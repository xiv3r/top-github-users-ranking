...
The `number of followers` of users in Armenia on `2025/12/11 12:45 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
