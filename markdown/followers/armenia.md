...
The `number of followers` of users in Armenia on `2025/2/23 5:42 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
