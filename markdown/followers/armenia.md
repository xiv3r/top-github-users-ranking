...
The `number of followers` of users in Armenia on `2025/2/20 6:49 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
