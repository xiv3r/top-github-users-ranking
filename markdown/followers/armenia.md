...
The `number of followers` of users in Armenia on `2025/9/30 7:04 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
