...
The `number of followers` of users in Armenia on `2025/11/2 6:52 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
