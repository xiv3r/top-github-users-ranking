...
The `number of followers` of users in Armenia on `2025/2/18 10:40 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
