...
The `number of followers` of users in Armenia on `2025/11/12 5:00 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
