...
The `number of followers` of users in Armenia on `2025/3/17 3:36 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
