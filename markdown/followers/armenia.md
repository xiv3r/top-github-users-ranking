...
The `number of followers` of users in Armenia on `2025/6/23 3:38 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
