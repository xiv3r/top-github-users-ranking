...
The `number of followers` of users in Armenia on `2025/10/31 5:55 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
