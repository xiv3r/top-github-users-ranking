...
The `number of followers` of users in Armenia on `2025/7/4 10:50 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
