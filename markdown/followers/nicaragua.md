...
The `number of followers` of users in Nicaragua on `2026/3/18 12:02 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
