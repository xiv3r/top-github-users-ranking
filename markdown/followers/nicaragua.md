...
The `number of followers` of users in Nicaragua on `2026/1/22 4:32 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
