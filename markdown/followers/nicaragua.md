...
The `number of followers` of users in Nicaragua on `2025/8/13 5:53 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
