...
The `number of followers` of users in Nicaragua on `2025/7/1 6:52 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
