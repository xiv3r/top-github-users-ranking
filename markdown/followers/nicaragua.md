...
The `number of followers` of users in Nicaragua on `2025/7/8 10:49 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
