...
The `number of followers` of users in Nicaragua on `2025/5/31 10:33 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
