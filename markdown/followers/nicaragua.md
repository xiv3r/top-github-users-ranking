...
The `number of followers` of users in Nicaragua on `2025/4/4 4:53 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
