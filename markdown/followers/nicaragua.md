...
The `number of followers` of users in Nicaragua on `2025/12/31 7:46 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
