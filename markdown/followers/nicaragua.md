...
The `number of followers` of users in Nicaragua on `2025/3/8 2:16 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
