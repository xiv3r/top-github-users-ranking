...
The `number of followers` of users in Nicaragua on `2026/2/20 11:59 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
