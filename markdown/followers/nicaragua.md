...
The `number of followers` of users in Nicaragua on `2025/3/11 7:43 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
