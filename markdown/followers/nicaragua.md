...
The `number of followers` of users in Nicaragua on `2025/5/18 3:06 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
