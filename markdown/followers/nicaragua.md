...
The `number of followers` of users in Nicaragua on `2025/2/19 1:38 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
