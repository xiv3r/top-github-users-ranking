...
The `number of followers` of users in Nicaragua on `2025/1/27 10:33 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
