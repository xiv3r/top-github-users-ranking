...
The `number of followers` of users in Nicaragua on `2025/8/28 4:42 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
