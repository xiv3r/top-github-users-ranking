...
The `number of followers` of users in Nicaragua on `2025/4/6 11:19 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
