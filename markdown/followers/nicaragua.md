...
The `number of followers` of users in Nicaragua on `2025/11/1 10:52 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
