...
The `number of followers` of users in Nicaragua on `2025/10/12 6:42 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
