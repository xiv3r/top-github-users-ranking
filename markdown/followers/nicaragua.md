...
The `number of followers` of users in Nicaragua on `2025/2/24 7:57 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
