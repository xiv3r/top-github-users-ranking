...
The `number of followers` of users in Nicaragua on `2026/1/3 1:24 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
