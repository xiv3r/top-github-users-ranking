...
The `number of followers` of users in Nicaragua on `2025/3/2 6:45 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
