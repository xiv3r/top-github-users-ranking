...
The `number of followers` of users in Nicaragua on `2025/5/4 10:52 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
