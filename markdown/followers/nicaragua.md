...
The `number of followers` of users in Nicaragua on `2025/1/19 5:38 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
