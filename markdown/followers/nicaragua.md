...
The `number of followers` of users in Nicaragua on `2025/11/25 9:40 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
