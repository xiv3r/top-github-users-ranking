...
The `number of followers` of users in Nicaragua on `2026/1/30 7:17 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
