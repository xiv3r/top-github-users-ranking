...
The `number of followers` of users in Nicaragua on `2025/7/24 11:22 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
