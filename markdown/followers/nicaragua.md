...
The `number of followers` of users in Nicaragua on `2026/2/13 6:44 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
