...
The `number of followers` of users in Nicaragua on `2025/10/10 5:48 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
