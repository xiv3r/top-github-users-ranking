...
The `number of followers` of users in Nicaragua on `2025/5/20 8:57 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
