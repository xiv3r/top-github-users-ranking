...
The `number of followers` of users in Nicaragua on `2025/4/27 1:21 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
