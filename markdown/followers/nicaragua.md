...
The `number of followers` of users in Nicaragua on `2025/3/9 2:05 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
