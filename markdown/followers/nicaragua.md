...
The `number of followers` of users in Nicaragua on `2025/5/22 3:33 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
