...
The `number of followers` of users in United States on `2025/1/22 6:32 AM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
