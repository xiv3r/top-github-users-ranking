...
The `number of followers` of users in United States on `2025/3/9 11:30 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
