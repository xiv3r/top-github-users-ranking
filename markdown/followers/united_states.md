...
The `number of followers` of users in United States on `2025/6/23 10:33 AM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/datawrangling">
				<img src="https://avatars.githubusercontent.com/u/60860?s=72&v=4" width="24" alt="Avatar of datawrangling"> datawrangling
			</a><br/>
			Pete Skomoroch
		</td>
		<td>Skipflag </td>
