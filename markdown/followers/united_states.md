...
The `number of followers` of users in United States on `2025/7/19 7:24 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
