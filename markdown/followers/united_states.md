...
The `number of followers` of users in United States on `2025/6/3 7:08 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
