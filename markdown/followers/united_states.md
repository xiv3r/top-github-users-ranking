...
The `number of followers` of users in United States on `2025/2/23 2:16 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
