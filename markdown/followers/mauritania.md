...
The `number of followers` of users in Mauritania on `2025/6/5 7:52 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
