...
The `number of followers` of users in Mauritania on `2025/1/5 6:36 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
