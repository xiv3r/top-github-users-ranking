...
The `number of followers` of users in Mauritania on `2025/8/23 3:44 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
