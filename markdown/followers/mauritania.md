...
The `number of followers` of users in Mauritania on `2026/1/9 5:02 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
