...
The `number of followers` of users in Mauritania on `2025/7/3 9:37 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
