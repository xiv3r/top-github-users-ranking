...
The `number of followers` of users in Mauritania on `2025/8/30 3:46 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
