...
The `number of followers` of users in Mauritania on `2025/12/26 7:02 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
