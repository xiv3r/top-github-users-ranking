...
The `number of followers` of users in Mauritania on `2026/7/9 5:19 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
