...
The `number of followers` of users in Mauritania on `2026/1/11 7:56 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
