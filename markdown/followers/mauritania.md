...
The `number of followers` of users in Mauritania on `2025/3/24 2:02 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
