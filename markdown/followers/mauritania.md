...
The `number of followers` of users in Mauritania on `2026/3/25 9:03 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
