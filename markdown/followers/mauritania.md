...
The `number of followers` of users in Mauritania on `2025/7/18 7:57 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
