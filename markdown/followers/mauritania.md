...
The `number of followers` of users in Mauritania on `2025/9/7 2:45 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
