...
The `number of followers` of users in Mauritania on `2025/4/14 9:40 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
