...
The `number of followers` of users in Mauritania on `2025/4/20 11:40 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
