...
The `number of followers` of users in Mauritania on `2025/3/29 6:19 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
