...
The `number of followers` of users in Mauritania on `2026/9/2 2:01 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
