...
The `number of followers` of users in Mauritania on `2025/12/23 2:01 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
