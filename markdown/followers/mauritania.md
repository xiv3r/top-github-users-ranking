...
The `number of followers` of users in Mauritania on `2025/3/16 5:03 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
