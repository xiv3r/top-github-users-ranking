...
The `number of followers` of users in Mauritania on `2025/5/4 7:25 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
