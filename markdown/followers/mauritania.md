...
The `number of followers` of users in Mauritania on `2025/4/29 3:49 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
