...
The `number of followers` of users in Colombia on `2025/7/17 9:31 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
