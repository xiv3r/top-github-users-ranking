...
The `number of followers` of users in Colombia on `2026/1/27 10:32 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
