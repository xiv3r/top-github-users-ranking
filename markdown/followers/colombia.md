...
The `number of followers` of users in Colombia on `2025/5/14 11:56 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
