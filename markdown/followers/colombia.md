...
The `number of followers` of users in Colombia on `2026/2/17 8:10 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
