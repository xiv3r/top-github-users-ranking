...
The `number of followers` of users in Colombia on `2025/9/14 2:42 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
