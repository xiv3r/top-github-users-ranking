...
The `number of followers` of users in Colombia on `2025/10/5 8:04 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
