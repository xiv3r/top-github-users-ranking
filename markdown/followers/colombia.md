...
The `number of followers` of users in Colombia on `2025/5/28 8:02 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
