...
The `number of followers` of users in Colombia on `2026/1/13 9:32 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
