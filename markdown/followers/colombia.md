...
The `number of followers` of users in Colombia on `2026/1/2 10:59 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
