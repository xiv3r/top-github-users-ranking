...
The `number of followers` of users in Colombia on `2025/11/5 3:22 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
