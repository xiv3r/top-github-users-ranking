...
The `number of followers` of users in Colombia on `2025/7/26 9:34 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
