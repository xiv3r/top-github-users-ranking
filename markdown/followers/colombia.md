...
The `number of followers` of users in Colombia on `2025/5/23 10:44 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
