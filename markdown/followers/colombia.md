...
The `number of followers` of users in Colombia on `2025/12/14 1:45 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
