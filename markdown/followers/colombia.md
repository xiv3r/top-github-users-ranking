...
The `number of followers` of users in Colombia on `2026/3/14 7:21 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
