...
The `number of followers` of users in Colombia on `2025/3/1 1:01 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
