...
The `number of followers` of users in Colombia on `2025/4/7 11:45 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
