...
The `number of followers` of users in Colombia on `2025/3/25 9:53 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
