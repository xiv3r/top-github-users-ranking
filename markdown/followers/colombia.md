...
The `number of followers` of users in Colombia on `2026/7/4 12:51 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
