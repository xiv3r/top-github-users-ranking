...
The `number of followers` of users in Colombia on `2025/9/24 4:40 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
