...
The `number of followers` of users in Colombia on `2026/3/22 7:59 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
