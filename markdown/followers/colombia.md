...
The `number of followers` of users in Colombia on `2026/3/6 12:52 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
