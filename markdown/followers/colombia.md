...
The `number of followers` of users in Colombia on `2025/4/9 7:05 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
