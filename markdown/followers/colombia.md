...
The `number of followers` of users in Colombia on `2025/10/20 2:50 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
