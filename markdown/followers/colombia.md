...
The `number of followers` of users in Colombia on `2026/2/25 8:15 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
