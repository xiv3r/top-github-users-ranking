...
The `number of followers` of users in Colombia on `2025/1/9 12:46 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
