...
The `number of followers` of users in Colombia on `2025/11/22 2:33 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
