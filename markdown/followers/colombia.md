...
The `number of followers` of users in Colombia on `2026/8/25 6:39 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
