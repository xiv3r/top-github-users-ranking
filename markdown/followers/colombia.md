...
The `number of followers` of users in Colombia on `2025/1/12 9:29 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
