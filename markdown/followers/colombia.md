...
The `number of followers` of users in Colombia on `2025/3/10 11:00 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
