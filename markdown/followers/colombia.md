...
The `number of followers` of users in Colombia on `2025/8/9 12:07 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
