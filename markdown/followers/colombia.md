...
The `number of followers` of users in Colombia on `2025/9/26 10:12 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
