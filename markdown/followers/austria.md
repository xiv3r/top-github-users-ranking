...
The `number of followers` of users in Austria on `2025/10/11 3:38 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/kosmoz">
				<img src="https://avatars.githubusercontent.com/u/16959694?s=72&u=96568a2b0b40dc541d8582ddd66fba6d4715ecd7&v=4" width="24" alt="Avatar of kosmoz"> kosmoz
			</a><br/>
			Jakob Steiner
		</td>
		<td>@glasskube </td>
