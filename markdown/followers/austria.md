...
The `number of followers` of users in Austria on `2025/8/4 9:47 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `941 users`  in Austria. You need at least `53 followers` to be on this list.
