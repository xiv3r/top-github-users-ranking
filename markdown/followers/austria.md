...
The `number of followers` of users in Austria on `2026/8/9 9:19 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `930 users`  in Austria. You need at least `60 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ACoolioDude">
				<img src="https://avatars.githubusercontent.com/u/126715034?s=72&u=a735e4d0313e4dae56f8e6cbb9eaf45da41c8101&v=4" width="24" alt="Avatar of ACoolioDude"> ACoolioDude
			</a><br/>
			Stefan
		</td>
		<td>Null </td>
