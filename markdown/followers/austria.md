...
The `number of followers` of users in Austria on `2026/5/11 12:43 PM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `931 users`  in Austria. You need at least `58 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ACoolioDude">
				<img src="https://avatars.githubusercontent.com/u/126715034?s=72&u=f86838fde0a1c3217456ec5d440b718580050b2c&v=4" width="24" alt="Avatar of ACoolioDude"> ACoolioDude
			</a><br/>
			Stefan
		</td>
		<td>Null </td>
