...
The `number of followers` of users in Venezuela on `2024/12/30 3:03 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
