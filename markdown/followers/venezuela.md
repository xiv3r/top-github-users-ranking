...
The `number of followers` of users in Venezuela on `2025/8/11 5:13 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
