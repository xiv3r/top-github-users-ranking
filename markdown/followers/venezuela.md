...
The `number of followers` of users in Venezuela on `2025/1/20 7:53 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
