...
The `number of followers` of users in Venezuela on `2025/5/18 7:16 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
