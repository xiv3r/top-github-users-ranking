...
The `number of followers` of users in Venezuela on `2025/1/10 3:02 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
