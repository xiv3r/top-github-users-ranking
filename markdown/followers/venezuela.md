...
The `number of followers` of users in Venezuela on `2025/9/14 4:01 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
