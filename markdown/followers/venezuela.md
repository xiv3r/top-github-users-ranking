...
The `number of followers` of users in Venezuela on `2025/8/16 10:21 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
