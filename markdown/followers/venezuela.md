...
The `number of followers` of users in Venezuela on `2025/3/21 8:39 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
