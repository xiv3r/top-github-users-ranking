...
The `number of followers` of users in Venezuela on `2025/2/7 10:50 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
