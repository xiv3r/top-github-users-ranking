...
The `number of followers` of users in Venezuela on `2025/4/21 8:40 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
