...
The `number of followers` of users in Venezuela on `2025/6/25 6:21 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
