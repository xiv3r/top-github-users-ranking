...
The `number of followers` of users in Venezuela on `2025/11/2 3:32 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
