...
The `number of followers` of users in Venezuela on `2025/6/16 7:08 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
