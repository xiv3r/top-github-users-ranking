...
The `number of followers` of users in Venezuela on `2025/1/31 5:05 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
