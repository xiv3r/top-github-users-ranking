...
The `number of followers` of users in Venezuela on `2025/4/13 5:58 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
