...
The `number of followers` of users in Venezuela on `2025/6/19 5:34 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
