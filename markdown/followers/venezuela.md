...
The `number of followers` of users in Venezuela on `2025/6/8 9:37 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
