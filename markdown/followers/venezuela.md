...
The `number of followers` of users in Venezuela on `2025/7/22 11:17 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
