...
The `number of followers` of users in Kuwait on `2025/2/3 9:31 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
