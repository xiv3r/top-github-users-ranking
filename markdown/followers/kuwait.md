...
The `number of followers` of users in Kuwait on `2025/2/17 10:19 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
