...
The `number of followers` of users in Kuwait on `2025/9/10 9:40 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
