...
The `number of followers` of users in Kuwait on `2025/8/25 6:05 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
