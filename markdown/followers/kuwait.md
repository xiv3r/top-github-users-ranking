...
The `number of followers` of users in Kuwait on `2025/3/23 9:47 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
