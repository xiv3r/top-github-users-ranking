...
The `number of followers` of users in Kuwait on `2025/9/29 1:51 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
