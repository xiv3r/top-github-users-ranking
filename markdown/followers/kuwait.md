...
The `number of followers` of users in Kuwait on `2025/1/30 8:26 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
