...
The `number of followers` of users in Kuwait on `2025/2/22 6:49 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
