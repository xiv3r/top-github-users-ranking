...
The `number of followers` of users in Kuwait on `2026/1/3 1:07 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
