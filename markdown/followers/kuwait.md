...
The `number of followers` of users in Kuwait on `2025/4/18 8:53 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
