...
The `number of followers` of users in Kuwait on `2025/3/1 9:56 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
