...
The `number of followers` of users in Kuwait on `2025/12/28 3:20 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
