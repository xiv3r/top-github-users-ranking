...
The `number of followers` of users in Kuwait on `2025/5/8 9:32 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
