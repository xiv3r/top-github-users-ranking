...
The `number of followers` of users in Kuwait on `2025/1/29 3:46 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
