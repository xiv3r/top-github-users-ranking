...
The `number of followers` of users in Kuwait on `2025/7/12 5:30 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
