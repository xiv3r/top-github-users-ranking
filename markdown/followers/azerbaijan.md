...
The `number of followers` of users in Azerbaijan on `2025/1/6 5:00 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
