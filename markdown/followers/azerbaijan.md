...
The `number of followers` of users in Azerbaijan on `2025/4/30 8:28 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
