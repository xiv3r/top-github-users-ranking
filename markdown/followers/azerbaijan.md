...
The `number of followers` of users in Azerbaijan on `2025/10/2 11:01 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
