...
The `number of followers` of users in Morocco on `2025/1/19 3:45 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
