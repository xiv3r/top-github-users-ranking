...
The `number of followers` of users in Cyprus on `2025/5/19 9:53 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
