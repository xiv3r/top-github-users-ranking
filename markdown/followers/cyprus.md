...
The `number of followers` of users in Cyprus on `2025/4/1 10:02 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
