...
The `number of followers` of users in Cyprus on `2024/12/30 2:59 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
