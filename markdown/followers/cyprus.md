...
The `number of followers` of users in Cyprus on `2025/2/1 5:01 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
