...
The `number of followers` of users in Sri Lanka on `2025/12/19 6:04 AM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
