...
The `number of followers` of users in Sri Lanka on `2025/5/20 7:01 PM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
