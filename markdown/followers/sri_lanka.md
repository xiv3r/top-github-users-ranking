...
The `number of followers` of users in Sri Lanka on `2025/9/30 9:04 AM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
