...
The `number of followers` of users in Sri Lanka on `2025/2/16 8:05 AM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
