...
The `number of followers` of users in Malta on `2025/12/26 6:47 AM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.
