...
The `number of followers` of users in Malta on `2025/9/20 3:54 PM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.
...
<table>
	...
	<tr>
		...
		<td>Hidlabs - Web Development<br/>&<br/>Ai<br/>Engineering<br/></td>
		<td>No Twitter Username</td>
		<td>Malta</td>
		<td>3</td>
	</tr>
