...
The `number of followers` of users in Malta on `2025/11/13 11:51 AM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.
...
<table>
	...
	<tr>
		<td>772</td>
		<td>
			<a href="https://github.com/ElGabbu">
				<img src="https://avatars.githubusercontent.com/u/603404?s=72&v=4" width="24" alt="Avatar of ElGabbu"> ElGabbu
			</a><br/>
			Gabriel Spiteri
		</td>
		<td>Highlight Media </td>
		<td>No Twitter Username</td>
		<td>Malta</td>
		<td>2</td>
	</tr>
