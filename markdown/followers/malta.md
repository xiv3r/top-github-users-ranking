...
The `number of followers` of users in Malta on `2025/7/28 6:06 AM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/viktorchobanov">
				<img src="https://avatars.githubusercontent.com/u/15705816?s=72&v=4" width="24" alt="Avatar of viktorchobanov"> viktorchobanov
			</a><br/>
			Viktor Chobanov
		</td>
		<td>No Company</td>
