...
The `number of followers` of users in Uruguay on `2026/9/10 3:12 PM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/GabiAcosta">
				<img src="https://avatars.githubusercontent.com/u/85908880?s=72&v=4" width="24" alt="Avatar of GabiAcosta"> GabiAcosta
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
