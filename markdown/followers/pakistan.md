...
The `number of followers` of users in Pakistan on `2025/1/2 7:48 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
