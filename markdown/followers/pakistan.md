...
The `number of followers` of users in Pakistan on `2026/2/13 11:19 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
