...
The `number of followers` of users in Pakistan on `2025/2/9 4:24 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
