...
The `number of followers` of users in Pakistan on `2025/5/18 5:00 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
