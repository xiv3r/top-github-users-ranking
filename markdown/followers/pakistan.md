...
The `number of followers` of users in Pakistan on `2025/3/20 6:52 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
