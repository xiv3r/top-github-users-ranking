...
The `number of followers` of users in Pakistan on `2025/2/1 9:26 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
