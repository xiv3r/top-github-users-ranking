...
The `number of followers` of users in Pakistan on `2025/8/13 7:44 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
