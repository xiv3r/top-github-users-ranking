...
The `number of followers` of users in United Arab Emirates on `2025/2/5 11:18 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
