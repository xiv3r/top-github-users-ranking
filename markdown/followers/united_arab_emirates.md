...
The `number of followers` of users in United Arab Emirates on `2025/5/4 9:16 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
