...
The `number of followers` of users in United Arab Emirates on `2025/7/13 4:24 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
