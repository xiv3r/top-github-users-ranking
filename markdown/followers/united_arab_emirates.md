...
The `number of followers` of users in United Arab Emirates on `2025/11/28 11:40 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
