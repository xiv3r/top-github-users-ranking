...
The `number of followers` of users in United Arab Emirates on `2025/8/19 10:46 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
