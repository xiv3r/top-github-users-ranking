...
The `number of followers` of users in United Arab Emirates on `2025/10/4 5:44 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
