...
The `number of followers` of users in United Arab Emirates on `2025/8/7 9:39 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
