...
The `number of followers` of users in United Arab Emirates on `2025/4/5 4:57 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
