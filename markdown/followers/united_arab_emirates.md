...
The `number of followers` of users in United Arab Emirates on `2025/5/27 4:35 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
