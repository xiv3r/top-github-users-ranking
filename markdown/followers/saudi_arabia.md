...
The `number of followers` of users in Saudi Arabia on `2025/9/16 5:02 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
