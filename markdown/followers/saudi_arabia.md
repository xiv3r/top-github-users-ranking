...
The `number of followers` of users in Saudi Arabia on `2025/4/27 5:53 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
