...
The `number of followers` of users in Saudi Arabia on `2026/1/9 7:48 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
