...
The `number of followers` of users in Saudi Arabia on `2025/4/23 10:00 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
