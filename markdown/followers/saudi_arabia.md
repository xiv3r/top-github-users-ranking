...
The `number of followers` of users in Saudi Arabia on `2025/8/24 3:41 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
