...
The `number of followers` of users in Saudi Arabia on `2025/7/6 11:34 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
