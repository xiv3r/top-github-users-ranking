...
The `number of followers` of users in Saudi Arabia on `2025/2/5 5:50 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
