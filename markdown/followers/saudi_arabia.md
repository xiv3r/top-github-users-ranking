...
The `number of followers` of users in Saudi Arabia on `2025/2/16 5:31 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
