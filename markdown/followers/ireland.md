...
The `number of followers` of users in Ireland on `2025/1/1 6:56 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
