...
The `number of followers` of users in Ireland on `2025/4/10 5:00 AM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
