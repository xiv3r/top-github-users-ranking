...
The `number of followers` of users in Burundi on `2025/6/23 8:54 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
