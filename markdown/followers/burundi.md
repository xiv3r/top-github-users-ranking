...
The `number of followers` of users in Burundi on `2026/1/20 9:01 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
