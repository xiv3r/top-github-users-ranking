...
The `number of followers` of users in Burundi on `2025/3/25 7:00 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
