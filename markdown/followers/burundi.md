...
The `number of followers` of users in Burundi on `2025/2/27 2:59 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
