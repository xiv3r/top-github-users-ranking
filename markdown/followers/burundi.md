...
The `number of followers` of users in Burundi on `2025/8/22 6:41 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
