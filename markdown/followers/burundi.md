...
The `number of followers` of users in Burundi on `2025/5/16 11:09 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
