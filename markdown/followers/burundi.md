...
The `number of followers` of users in Burundi on `2025/7/2 10:46 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
