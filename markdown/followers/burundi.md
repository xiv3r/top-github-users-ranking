...
The `number of followers` of users in Burundi on `2025/10/11 7:27 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
