...
The `number of followers` of users in Burundi on `2026/4/1 8:05 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
