...
The `number of followers` of users in Burundi on `2025/10/20 10:52 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
