...
The `number of followers` of users in Burundi on `2025/7/17 5:45 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
