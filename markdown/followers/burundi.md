...
The `number of followers` of users in Burundi on `2025/12/30 11:48 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
