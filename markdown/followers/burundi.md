...
The `number of followers` of users in Burundi on `2025/1/16 7:47 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
