...
The `number of followers` of users in Burundi on `2025/3/12 5:42 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
