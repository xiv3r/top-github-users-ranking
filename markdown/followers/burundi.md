...
The `number of followers` of users in Burundi on `2025/6/8 5:48 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
