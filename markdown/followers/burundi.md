...
The `number of followers` of users in Burundi on `2025/11/9 10:00 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
