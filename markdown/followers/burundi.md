...
The `number of followers` of users in Burundi on `2025/9/8 4:00 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
