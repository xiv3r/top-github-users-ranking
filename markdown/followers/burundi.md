...
The `number of followers` of users in Burundi on `2025/3/23 10:02 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
