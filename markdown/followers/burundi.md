...
The `number of followers` of users in Burundi on `2025/9/17 1:17 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
