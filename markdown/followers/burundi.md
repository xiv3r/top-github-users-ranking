...
The `number of followers` of users in Burundi on `2025/12/4 4:05 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
