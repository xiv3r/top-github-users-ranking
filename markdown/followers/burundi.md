...
The `number of followers` of users in Burundi on `2025/1/26 11:30 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
