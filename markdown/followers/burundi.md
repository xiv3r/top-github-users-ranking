...
The `number of followers` of users in Burundi on `2025/5/19 5:27 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
