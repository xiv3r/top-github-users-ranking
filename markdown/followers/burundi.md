...
The `number of followers` of users in Burundi on `2026/1/16 10:34 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
