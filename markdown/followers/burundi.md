...
The `number of followers` of users in Burundi on `2025/8/27 8:37 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
