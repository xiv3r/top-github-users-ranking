...
The `number of followers` of users in Burundi on `2025/4/11 2:43 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
