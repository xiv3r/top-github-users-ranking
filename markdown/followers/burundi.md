...
The `number of followers` of users in Burundi on `2025/2/20 10:48 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
