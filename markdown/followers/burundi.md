...
The `number of followers` of users in Burundi on `2025/9/3 3:37 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
