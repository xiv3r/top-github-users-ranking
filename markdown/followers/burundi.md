...
The `number of followers` of users in Burundi on `2025/4/5 1:52 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
