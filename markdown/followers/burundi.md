...
The `number of followers` of users in Burundi on `2025/10/16 2:20 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
