...
The `number of followers` of users in Burundi on `2025/10/24 10:57 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
