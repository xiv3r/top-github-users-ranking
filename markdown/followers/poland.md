...
The `number of followers` of users in Poland on `2026/2/13 7:30 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
