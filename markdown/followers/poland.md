...
The `number of followers` of users in Poland on `2025/4/12 4:00 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
