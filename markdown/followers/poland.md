...
The `number of followers` of users in Poland on `2025/5/18 7:00 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
