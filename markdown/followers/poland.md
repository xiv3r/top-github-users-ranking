...
The `number of followers` of users in Poland on `2025/12/5 4:05 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
