...
The `number of followers` of users in Poland on `2025/4/19 8:45 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
