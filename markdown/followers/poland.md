...
The `number of followers` of users in Poland on `2025/10/4 9:39 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
