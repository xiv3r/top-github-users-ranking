...
The `number of followers` of users in Poland on `2025/1/4 7:08 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
