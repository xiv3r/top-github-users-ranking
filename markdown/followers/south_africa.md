...
The `number of followers` of users in South Africa on `2025/4/3 3:47 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
