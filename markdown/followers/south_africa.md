...
The `number of followers` of users in South Africa on `2025/2/5 7:39 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
