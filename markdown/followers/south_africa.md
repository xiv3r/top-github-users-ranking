...
The `number of followers` of users in South Africa on `2025/4/14 10:29 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
