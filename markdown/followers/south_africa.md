...
The `number of followers` of users in South Africa on `2025/1/10 8:06 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
