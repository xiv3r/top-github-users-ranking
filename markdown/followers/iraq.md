...
The `number of followers` of users in Iraq on `2026/1/14 12:08 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
...
<table>
	...
	<tr>
		...
		<td>Gate Way For Telecommunications<br/><br/></td>
		<td>No Twitter Username</td>
		<td>Iraq - Erbil</td>
		<td>6</td>
	</tr>
