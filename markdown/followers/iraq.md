...
The `number of followers` of users in Iraq on `2025/5/11 11:35 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `804 users`  in Iraq. You need at least `7 followers` to be on this list.
