...
The `number of followers` of users in Benin on `2025/10/5 1:30 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
