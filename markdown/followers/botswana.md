...
The `number of followers` of users in Botswana on `2026/4/10 9:56 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
