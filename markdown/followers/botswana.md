...
The `number of followers` of users in Botswana on `2025/9/6 6:53 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ALFRED-design110">
				<img src="https://avatars.githubusercontent.com/u/77567257?s=72&v=4" width="24" alt="Avatar of ALFRED-design110"> ALFRED-design110
			</a><br/>
			Alfred Thelang
		</td>
		<td>No Company</td>
