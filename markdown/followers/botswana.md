...
The `number of followers` of users in Botswana on `2026/2/17 3:29 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
