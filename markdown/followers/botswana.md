...
The `number of followers` of users in Botswana on `2025/7/20 11:43 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
