...
The `number of followers` of users in Botswana on `2025/8/17 9:33 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
