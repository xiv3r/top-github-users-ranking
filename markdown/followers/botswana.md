...
The `number of followers` of users in Botswana on `2025/7/9 1:59 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
