...
The `number of followers` of users in Botswana on `2025/12/19 10:12 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
