...
The `number of followers` of users in Botswana on `2026/1/10 5:57 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
