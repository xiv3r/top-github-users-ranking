...
The `number of followers` of users in Botswana on `2025/9/28 5:45 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
