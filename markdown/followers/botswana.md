...
The `number of followers` of users in Botswana on `2025/7/7 5:34 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
