...
The `number of followers` of users in Botswana on `2025/10/18 7:18 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
