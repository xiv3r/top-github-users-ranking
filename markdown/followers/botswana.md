...
The `number of followers` of users in Botswana on `2026/1/4 5:43 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
