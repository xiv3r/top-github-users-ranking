...
The `number of followers` of users in Botswana on `2025/12/14 8:55 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
