...
The `number of followers` of users in Botswana on `2025/10/3 4:48 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
