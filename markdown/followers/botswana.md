...
The `number of followers` of users in Botswana on `2026/7/3 1:15 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
