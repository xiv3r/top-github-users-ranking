...
The `number of followers` of users in Botswana on `2025/7/23 1:19 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
