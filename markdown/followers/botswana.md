...
The `number of followers` of users in Botswana on `2025/9/22 2:29 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
