...
The `number of followers` of users in Botswana on `2025/8/27 7:25 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
