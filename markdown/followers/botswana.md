...
The `number of followers` of users in Botswana on `2025/6/23 7:48 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
