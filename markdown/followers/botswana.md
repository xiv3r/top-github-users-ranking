...
The `number of followers` of users in Botswana on `2025/10/7 5:22 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
