...
The `number of followers` of users in Botswana on `2025/11/26 2:49 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
