...
The `number of followers` of users in Botswana on `2026/1/7 8:04 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
