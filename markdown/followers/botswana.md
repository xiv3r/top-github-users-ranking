...
The `number of followers` of users in Botswana on `2026/8/9 7:17 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
