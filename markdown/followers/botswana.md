...
The `number of followers` of users in Botswana on `2025/11/28 10:02 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
