...
The `number of followers` of users in Botswana on `2025/12/11 7:20 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
