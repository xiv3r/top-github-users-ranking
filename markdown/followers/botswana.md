...
The `number of followers` of users in Botswana on `2025/12/3 11:48 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
