...
The `number of followers` of users in Botswana on `2025/8/19 9:50 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
