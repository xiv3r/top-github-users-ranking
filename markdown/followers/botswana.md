...
The `number of followers` of users in Botswana on `2026/3/5 3:20 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
