...
The `number of followers` of users in Botswana on `2025/12/1 6:41 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
