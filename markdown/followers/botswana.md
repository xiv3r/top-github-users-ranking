...
The `number of followers` of users in Botswana on `2026/1/20 6:58 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
