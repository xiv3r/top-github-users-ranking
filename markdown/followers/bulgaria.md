...
The `number of followers` of users in Bulgaria on `2025/1/8 7:54 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
