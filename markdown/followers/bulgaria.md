...
The `number of followers` of users in Bulgaria on `2025/7/23 2:24 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
