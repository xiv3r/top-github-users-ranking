...
The `number of followers` of users in Bulgaria on `2025/7/2 9:57 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
