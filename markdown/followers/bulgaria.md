...
The `number of followers` of users in Bulgaria on `2025/2/4 1:21 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
