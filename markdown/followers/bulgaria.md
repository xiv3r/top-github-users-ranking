...
The `number of followers` of users in Bulgaria on `2025/2/20 10:19 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
