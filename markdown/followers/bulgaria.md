...
The `number of followers` of users in Bulgaria on `2025/5/23 7:50 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
