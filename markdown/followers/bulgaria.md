...
The `number of followers` of users in Bulgaria on `2025/3/27 5:01 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
