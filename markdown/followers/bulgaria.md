...
The `number of followers` of users in Bulgaria on `2025/11/9 9:28 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
