...
The `number of followers` of users in Bulgaria on `2025/9/30 11:11 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
