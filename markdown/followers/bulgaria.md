...
The `number of followers` of users in Bulgaria on `2025/1/30 6:00 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
