...
The `number of followers` of users in Bulgaria on `2025/11/7 8:29 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
