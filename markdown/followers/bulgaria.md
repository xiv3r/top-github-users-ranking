...
The `number of followers` of users in Bulgaria on `2025/12/4 1:50 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
