...
The `number of followers` of users in Bulgaria on `2025/10/3 5:27 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
