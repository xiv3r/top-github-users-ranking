...
The `number of followers` of users in Bulgaria on `2025/10/5 4:56 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
