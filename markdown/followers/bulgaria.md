...
The `number of followers` of users in Bulgaria on `2025/8/5 6:55 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
