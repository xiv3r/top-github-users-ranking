...
The `number of followers` of users in Bulgaria on `2025/7/5 5:56 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
