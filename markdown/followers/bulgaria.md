...
The `number of followers` of users in Bulgaria on `2025/2/9 8:07 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
