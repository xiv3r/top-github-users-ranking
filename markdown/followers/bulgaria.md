...
The `number of followers` of users in Bulgaria on `2025/11/12 10:43 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
