...
The `number of followers` of users in Mozambique  on `2025/8/21 10:05 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
