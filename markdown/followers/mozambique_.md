...
The `number of followers` of users in Mozambique  on `2025/8/10 7:51 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
