...
The `number of followers` of users in Mozambique  on `2025/12/21 12:04 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
