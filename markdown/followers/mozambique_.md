...
The `number of followers` of users in Mozambique  on `2025/4/14 1:51 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
