...
The `number of followers` of users in Mozambique  on `2025/9/1 10:37 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
