...
The `number of followers` of users in Mozambique  on `2025/6/9 5:46 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
