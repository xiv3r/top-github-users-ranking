...
The `number of followers` of users in Mozambique  on `2025/3/20 3:51 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
