...
The `number of followers` of users in Mozambique  on `2025/8/28 2:07 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
