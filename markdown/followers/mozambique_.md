...
The `number of followers` of users in Mozambique  on `2025/3/2 4:57 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
