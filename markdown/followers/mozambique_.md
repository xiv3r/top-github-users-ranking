...
The `number of followers` of users in Mozambique  on `2026/1/18 5:01 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
