...
The `number of followers` of users in Mozambique  on `2025/7/18 11:06 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
