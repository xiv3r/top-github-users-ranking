...
The `number of followers` of users in Mozambique  on `2025/12/7 3:58 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
