...
The `number of followers` of users in Mozambique  on `2026/2/12 9:07 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
