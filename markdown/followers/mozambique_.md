...
The `number of followers` of users in Mozambique  on `2025/3/6 4:06 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
