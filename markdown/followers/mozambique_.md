...
The `number of followers` of users in Mozambique  on `2025/5/9 12:38 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
