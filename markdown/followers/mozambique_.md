...
The `number of followers` of users in Mozambique  on `2025/5/29 7:45 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
