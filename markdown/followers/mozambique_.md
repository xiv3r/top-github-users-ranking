...
The `number of followers` of users in Mozambique  on `2024/12/31 6:46 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
