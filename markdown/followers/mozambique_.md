...
The `number of followers` of users in Mozambique  on `2025/1/15 6:52 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
