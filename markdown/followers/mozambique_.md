...
The `number of followers` of users in Mozambique  on `2025/9/20 6:02 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
