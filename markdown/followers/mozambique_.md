...
The `number of followers` of users in Mozambique  on `2025/2/17 3:23 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
