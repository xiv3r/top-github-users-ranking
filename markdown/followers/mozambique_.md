...
The `number of followers` of users in Mozambique  on `2025/5/31 4:50 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
