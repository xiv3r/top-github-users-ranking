...
The `number of followers` of users in Mozambique  on `2025/10/8 8:27 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
