...
The `number of followers` of users in Mozambique  on `2025/11/4 3:39 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
