...
The `number of followers` of users in Mozambique  on `2025/7/31 10:34 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
