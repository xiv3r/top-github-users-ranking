...
The `number of followers` of users in Mozambique  on `2025/10/1 11:29 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
