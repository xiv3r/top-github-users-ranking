...
The `number of followers` of users in Mozambique  on `2025/3/29 7:56 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
