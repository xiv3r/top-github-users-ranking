...
The `number of followers` of users in Mozambique  on `2025/4/10 12:31 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
