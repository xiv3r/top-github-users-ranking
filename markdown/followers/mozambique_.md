...
The `number of followers` of users in Mozambique  on `2025/11/8 7:47 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
