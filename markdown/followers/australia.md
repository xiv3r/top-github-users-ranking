...
The `number of followers` of users in Australia on `2026/9/12 9:43 PM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/patrickgwsmith">patrickgwsmith</a></td>
		<td>Melbourne, Australia</td>
		<td>282</td>
	</tr>
	<tr>
