...
The `number of followers` of users in Australia on `2025/10/2 10:12 PM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		...
		<td>@john-bampton @64-shades @salamlang </td>
		<td>No Twitter Username</td>
		<td>Brisbane, Australia</td>
		<td>408</td>
	</tr>
