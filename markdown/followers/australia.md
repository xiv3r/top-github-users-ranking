...
The `number of followers` of users in Australia on `2026/2/16 2:22 PM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		<td>84</td>
		<td>
			<a href="https://github.com/lesterink">
	...
	<tr>
		<td>92</td>
		<td>
			<a href="https://github.com/cleinvert">
	...
	<tr>
		<td>270</td>
		<td>
			<a href="https://github.com/Jaures-beinjamin">
