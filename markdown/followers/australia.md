...
The `number of followers` of users in Australia on `2026/7/15 4:54 PM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		<td>258</td>
		<td>
			<a href="https://github.com/CooperSullivan-Dev">
	...
	<tr>
		<td>318</td>
		<td>
			<a href="https://github.com/dokejaker">
