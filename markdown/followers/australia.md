...
The `number of followers` of users in Australia on `2026/3/21 1:35 PM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		<td>78</td>
		<td>
			<a href="https://github.com/PaulConnyngham">
	...
	<tr>
		<td>122</td>
		<td>
			<a href="https://github.com/juanforde">
