...
The `number of followers` of users in Australia on `2026/6/13 7:01 PM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		<td>432</td>
		<td>
			<a href="https://github.com/SamanthaMiller0">
