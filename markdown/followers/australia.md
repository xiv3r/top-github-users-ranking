...
The `number of followers` of users in Australia on `2025/6/30 10:42 AM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/ill_computer">ill_computer</a></td>
		<td>Australia/USA</td>
		<td>145</td>
	</tr>
	<tr>
