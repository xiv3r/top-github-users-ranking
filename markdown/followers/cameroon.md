...
The `number of followers` of users in Cameroon on `2025/4/13 4:01 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
