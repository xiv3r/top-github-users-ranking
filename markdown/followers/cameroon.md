...
The `number of followers` of users in Cameroon on `2025/5/1 12:03 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
