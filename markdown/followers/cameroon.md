...
The `number of followers` of users in Cameroon on `2025/9/14 12:28 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
...
<table>
	...
	<tr>
		...
		<td>Hr-security </td>
		<td>No Twitter Username</td>
		<td>Cameroon,Nothr-West,Bamenda</td>
		<td>4</td>
	</tr>
	<tr>
		<td>858</td>
