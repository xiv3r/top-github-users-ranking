...
The `number of followers` of users in Andorra on `2025/4/5 8:47 AM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
