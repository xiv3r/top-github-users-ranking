...
The `number of followers` of users in Palestine on `2025/1/25 4:27 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
