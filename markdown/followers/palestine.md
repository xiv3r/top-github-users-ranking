...
The `number of followers` of users in Palestine on `2025/2/7 11:52 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
