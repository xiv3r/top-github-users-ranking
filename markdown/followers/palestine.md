...
The `number of followers` of users in Palestine on `2025/2/15 11:45 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
