...
The `number of followers` of users in Palestine on `2025/2/3 5:05 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
