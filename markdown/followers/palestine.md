...
The `number of followers` of users in Palestine on `2025/1/29 11:26 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
