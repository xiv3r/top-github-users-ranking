...
The `number of followers` of users in Turkey on `2025/3/17 9:41 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/0xdinozorselami">0xdinozorselami</a></td>
		<td>Turkey</td>
		<td>171</td>
	</tr>
	<tr>
