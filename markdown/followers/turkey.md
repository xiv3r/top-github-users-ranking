...
The `number of followers` of users in Turkey on `2025/12/8 9:25 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
...
<table>
	...
	<tr>
		...
		<td>@trendyol Group  |<br/>Software<br/>Developer<br/></td>
		<td>No Twitter Username</td>
		<td>Ankara, Türkiye</td>
		<td>170</td>
	</tr>
