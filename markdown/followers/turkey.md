...
The `number of followers` of users in Turkey on `2025/3/8 11:15 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
