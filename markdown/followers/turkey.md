...
The `number of followers` of users in Turkey on `2025/9/18 11:08 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
