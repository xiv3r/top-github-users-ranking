...
The `number of followers` of users in Turkey on `2025/1/18 8:52 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
...
<table>
	...
	<tr>
		...
		<td>@upwork, @outlier.ai, @datalensstrategies, Previous<br/>@neuralailab,<br/>@praiselab<br/></td>
