...
The `number of followers` of users in Turkey on `2025/8/10 10:31 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
