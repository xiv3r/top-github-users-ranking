...
The `number of followers` of users in Turkey on `2025/2/19 11:08 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
