...
The `number of followers` of users in Turkey on `2025/2/11 5:01 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
