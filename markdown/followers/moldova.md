...
The `number of followers` of users in Moldova on `2025/5/26 7:28 PM UTC`. This list contains users from `Moldova` and cities `Chișinău` `Tiraspol`.
...
<table>
	...
	<tr>
		...
		<td>Master's In Information Technology,<br/>Technical<br/>University<br/>Of<br/>Moldova<br/></td>
		<td>No Twitter Username</td>
		<td>Chișinău</td>
		<td>29</td>
	</tr>
