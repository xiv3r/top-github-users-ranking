...
The `number of followers` of users in Moldova on `2025/2/8 10:28 PM UTC`. This list contains users from `Moldova` and cities `Chișinău` `Tiraspol`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/alexandr_pumnea">alexandr_pumnea</a></td>
		<td>Moldova</td>
		<td>3</td>
	</tr>
	<tr>
