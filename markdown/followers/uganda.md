...
The `number of followers` of users in Uganda on `2025/12/21 7:03 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
...
<table>
	...
	<tr>
		...
		<td>Rocketize Technologies Ltd </td>
