...
The `number of followers` of users in Uganda on `2025/3/15 2:49 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
...
<table>
	...
	<tr>
		<td>964</td>
		<td>
			<a href="https://github.com/Jonahbob">
				<img src="https://avatars.githubusercontent.com/u/169344215?s=72&v=4" width="24" alt="Avatar of Jonahbob"> Jonahbob
			</a><br/>
			Masese Jonathan Bob
		</td>
		<td>No Company</td>
