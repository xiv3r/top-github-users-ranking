...
The `number of followers` of users in Peru on `2025/10/17 9:28 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
