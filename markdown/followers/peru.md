...
The `number of followers` of users in Peru on `2025/6/9 9:44 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
