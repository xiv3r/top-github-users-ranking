...
The `number of followers` of users in Peru on `2025/8/28 7:35 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
