...
The `number of followers` of users in Peru on `2025/11/27 10:30 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
