...
The `number of followers` of users in Peru on `2025/6/1 4:56 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
