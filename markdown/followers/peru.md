...
The `number of followers` of users in Peru on `2025/12/29 6:42 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
