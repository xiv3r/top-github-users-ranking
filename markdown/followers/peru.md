...
The `number of followers` of users in Peru on `2025/12/31 10:39 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
