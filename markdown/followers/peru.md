...
The `number of followers` of users in Peru on `2025/9/4 10:49 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
