...
The `number of followers` of users in Peru on `2025/9/2 5:41 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
