...
The `number of followers` of users in Peru on `2025/1/2 8:52 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
