...
The `number of followers` of users in Peru on `2025/12/21 8:59 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
