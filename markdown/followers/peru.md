...
The `number of followers` of users in Peru on `2026/1/18 10:55 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
