...
The `number of followers` of users in Peru on `2025/11/2 4:07 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
