...
The `number of followers` of users in Peru on `2025/2/23 5:06 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
