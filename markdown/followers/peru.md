...
The `number of followers` of users in Peru on `2025/4/19 7:59 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
