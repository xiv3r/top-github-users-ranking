...
The `number of followers` of users in Peru on `2025/3/28 5:55 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
