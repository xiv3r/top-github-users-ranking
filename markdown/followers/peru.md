...
The `number of followers` of users in Peru on `2025/9/23 8:31 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
