...
The `number of followers` of users in Peru on `2025/7/8 1:58 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
