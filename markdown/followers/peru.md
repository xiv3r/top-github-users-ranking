...
The `number of followers` of users in Peru on `2026/1/12 8:53 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
