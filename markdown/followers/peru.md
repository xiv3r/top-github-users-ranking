...
The `number of followers` of users in Peru on `2024/12/31 10:33 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
