...
The `number of followers` of users in Peru on `2025/1/29 11:58 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
