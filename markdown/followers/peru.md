...
The `number of followers` of users in Peru on `2025/4/2 8:59 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
