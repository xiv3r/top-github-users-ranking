...
The `number of followers` of users in Vietnam on `2025/6/12 4:53 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
