...
The `number of followers` of users in Vietnam on `2025/7/19 10:34 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
