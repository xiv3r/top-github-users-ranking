...
The `number of followers` of users in Vietnam on `2025/8/11 5:51 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
