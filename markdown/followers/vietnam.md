...
The `number of followers` of users in Vietnam on `2025/4/21 8:53 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
