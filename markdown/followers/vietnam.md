...
The `number of followers` of users in Vietnam on `2025/7/2 2:19 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
