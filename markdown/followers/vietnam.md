...
The `number of followers` of users in Vietnam on `2025/1/16 11:59 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
