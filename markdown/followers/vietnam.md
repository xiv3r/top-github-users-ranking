...
The `number of followers` of users in Vietnam on `2025/6/8 9:52 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
