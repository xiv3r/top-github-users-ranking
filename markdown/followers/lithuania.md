...
The `number of followers` of users in Lithuania on `2025/4/29 1:18 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
