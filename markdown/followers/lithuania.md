...
The `number of followers` of users in Lithuania on `2025/2/3 10:08 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
