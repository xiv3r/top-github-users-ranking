...
The `number of followers` of users in Lithuania on `2026/1/3 4:43 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
