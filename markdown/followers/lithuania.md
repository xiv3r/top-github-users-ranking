...
The `number of followers` of users in Lithuania on `2025/5/14 11:52 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
