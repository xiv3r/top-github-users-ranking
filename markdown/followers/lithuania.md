...
The `number of followers` of users in Lithuania on `2025/12/12 7:05 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
