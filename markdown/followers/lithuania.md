...
The `number of followers` of users in Lithuania on `2025/1/3 7:28 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
