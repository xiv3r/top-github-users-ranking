...
The `number of followers` of users in Lithuania on `2025/4/6 5:51 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
