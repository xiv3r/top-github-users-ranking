...
The `number of followers` of users in Lithuania on `2025/2/8 7:51 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
