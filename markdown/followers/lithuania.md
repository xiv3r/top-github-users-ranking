...
The `number of followers` of users in Lithuania on `2025/9/13 5:08 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
