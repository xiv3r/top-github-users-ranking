...
The `number of followers` of users in United Kingdom on `2025/8/31 9:50 AM UTC`. This list contains users from `United Kingdom` and cities `London` `Birmingham` `Edinburgh` `Manchester` `Glasgow` `Liverpool` `Bristol`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `809 users`  in United Kingdom. You need at least `280 followers` to be on this list.
