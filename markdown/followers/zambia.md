...
The `number of followers` of users in Zambia on `2025/11/11 11:30 PM UTC`. This list contains users from `Zambia` and cities ` Lusaka`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `874 users`  in Zambia. You need at least `1 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>872</td>
		<td>
			<a href="https://github.com/chilupe">
				<img src="https://avatars.githubusercontent.com/u/69219510?s=72&v=4" width="24" alt="Avatar of chilupe"> chilupe
			</a><br/>
			Shawn
		</td>
		<td>@toscana </td>
