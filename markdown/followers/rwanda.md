...
The `number of followers` of users in Rwanda on `2025/11/4 11:54 AM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
...
<table>
	...
	<tr>
		...
		<td>Echosols  | Loxotech<br/>|<br/>Rca<br/>|<br/>Rsa<br/></td>
