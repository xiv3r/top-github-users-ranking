...
The `number of followers` of users in Rwanda on `2025/1/25 7:16 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
...
<table>
	...
	<tr>
		...
		<td>@skillyhub @altech-congo @congoclub </td>
