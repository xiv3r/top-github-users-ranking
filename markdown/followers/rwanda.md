...
The `number of followers` of users in Rwanda on `2025/12/7 10:27 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
...
<table>
	...
	<tr>
		...
		<td>@binaryhubrw @csc2264 @codeit-girly @nexventuresltd<br/><br/></td>
		<td>No Twitter Username</td>
		<td>kigali</td>
		<td>22</td>
	</tr>
