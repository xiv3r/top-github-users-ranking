...
The `number of followers` of users in Kenya on `2025/5/3 9:54 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `775 users`  in Kenya. You need at least `77 followers` to be on this list.
