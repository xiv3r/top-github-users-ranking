...
The `number of followers` of users in Kenya on `2025/8/2 9:02 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
