...
The `number of followers` of users in Kenya on `2025/4/29 11:05 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
