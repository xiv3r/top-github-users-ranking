...
The `number of followers` of users in Kenya on `2024/12/30 10:53 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
