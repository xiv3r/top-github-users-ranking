...
The `number of followers` of users in Kenya on `2025/1/25 8:30 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
...
<table>
	...
	<tr>
		...
		<td>Pronic Inc. </td>
		<td><a href="https://twitter.com/nicksillver">nicksillver</a></td>
		<td>Kenya, Africa</td>
		<td>329</td>
	</tr>
	<tr>
