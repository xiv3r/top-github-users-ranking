...
The `number of followers` of users in Kenya on `2025/9/12 10:03 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `983 users`  in Kenya. You need at least `72 followers` to be on this list.
