...
The `number of followers` of users in Kenya on `2025/2/21 3:21 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
