...
The `number of followers` of users in Kenya on `2025/6/11 3:04 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
