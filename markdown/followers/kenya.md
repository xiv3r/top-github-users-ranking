...
The `number of followers` of users in Kenya on `2025/1/11 2:05 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
