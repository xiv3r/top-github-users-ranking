...
The `number of followers` of users in Kenya on `2025/9/10 9:24 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
