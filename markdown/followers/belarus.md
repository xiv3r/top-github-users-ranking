...
The `number of followers` of users in Belarus on `2025/4/30 9:08 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
