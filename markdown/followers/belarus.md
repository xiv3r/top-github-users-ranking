...
The `number of followers` of users in Belarus on `2025/8/8 11:59 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
