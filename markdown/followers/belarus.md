...
The `number of followers` of users in Belarus on `2025/10/18 5:25 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
