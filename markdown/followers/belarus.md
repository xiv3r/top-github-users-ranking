...
The `number of followers` of users in Belarus on `2025/10/4 11:48 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
