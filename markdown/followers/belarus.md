...
The `number of followers` of users in Belarus on `2025/6/12 9:33 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
