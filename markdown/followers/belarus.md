...
The `number of followers` of users in Belarus on `2025/2/16 5:21 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
