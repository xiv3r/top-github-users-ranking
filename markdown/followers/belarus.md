...
The `number of followers` of users in Belarus on `2025/11/16 7:59 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
