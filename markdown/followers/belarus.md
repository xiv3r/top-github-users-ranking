...
The `number of followers` of users in Belarus on `2025/10/13 5:30 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
