...
The `number of followers` of users in Belarus on `2025/3/12 1:18 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
