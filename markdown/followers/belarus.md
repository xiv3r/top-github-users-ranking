...
The `number of followers` of users in Belarus on `2025/12/11 3:52 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
