...
The `number of followers` of users in Belarus on `2025/2/14 11:47 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
