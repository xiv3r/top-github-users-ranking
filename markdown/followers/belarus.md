...
The `number of followers` of users in Belarus on `2025/8/24 6:52 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
