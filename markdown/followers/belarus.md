...
The `number of followers` of users in Belarus on `2025/1/20 12:02 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
