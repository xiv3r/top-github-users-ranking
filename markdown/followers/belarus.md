...
The `number of followers` of users in Belarus on `2025/6/19 11:23 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
