...
The `number of followers` of users in Belarus on `2025/12/22 6:39 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
