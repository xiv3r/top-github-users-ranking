...
The `number of followers` of users in Belarus on `2025/2/20 8:04 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
