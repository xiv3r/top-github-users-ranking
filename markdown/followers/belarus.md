...
The `number of followers` of users in Belarus on `2025/5/23 5:43 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
