...
The `number of followers` of users in Belarus on `2025/8/4 11:05 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
