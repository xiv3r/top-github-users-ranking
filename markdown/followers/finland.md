...
The `number of followers` of users in Finland on `2025/11/29 9:45 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
