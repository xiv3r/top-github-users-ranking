...
The `number of followers` of users in Finland on `2025/7/12 9:31 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
