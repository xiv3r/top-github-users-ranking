...
The `number of followers` of users in Finland on `2025/9/27 5:09 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
