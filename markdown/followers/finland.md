...
The `number of followers` of users in Finland on `2025/12/17 4:43 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
