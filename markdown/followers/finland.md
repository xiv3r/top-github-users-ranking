...
The `number of followers` of users in Finland on `2025/9/9 3:03 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
