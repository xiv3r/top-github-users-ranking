...
The `number of followers` of users in Finland on `2025/6/2 9:55 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
