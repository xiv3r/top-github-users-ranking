...
The `number of followers` of users in Finland on `2025/6/24 7:28 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
