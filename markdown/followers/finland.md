...
The `number of followers` of users in Finland on `2025/9/14 10:00 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
