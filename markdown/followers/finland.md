...
The `number of followers` of users in Finland on `2025/10/7 4:11 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
