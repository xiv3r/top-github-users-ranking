...
The `number of followers` of users in Finland on `2025/10/25 8:27 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
