...
The `number of followers` of users in Finland on `2025/6/13 10:51 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
