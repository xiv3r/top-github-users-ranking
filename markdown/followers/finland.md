...
The `number of followers` of users in Finland on `2025/6/28 6:45 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
