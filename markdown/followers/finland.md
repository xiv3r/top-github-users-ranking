...
The `number of followers` of users in Finland on `2026/6/19 4:00 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
