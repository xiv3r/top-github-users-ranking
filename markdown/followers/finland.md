...
The `number of followers` of users in Finland on `2025/1/22 11:57 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
