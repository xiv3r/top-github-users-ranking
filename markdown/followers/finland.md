...
The `number of followers` of users in Finland on `2025/1/20 10:18 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
