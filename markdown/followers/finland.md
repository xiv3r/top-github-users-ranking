...
The `number of followers` of users in Finland on `2025/1/13 3:59 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
