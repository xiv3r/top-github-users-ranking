...
The `number of followers` of users in Finland on `2025/12/22 8:37 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
