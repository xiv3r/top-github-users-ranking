...
The `number of followers` of users in Finland on `2025/11/15 7:22 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
