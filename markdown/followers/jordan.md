...
The `number of followers` of users in Jordan on `2025/4/7 9:31 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
