...
The `number of followers` of users in Jordan on `2025/11/3 6:44 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
