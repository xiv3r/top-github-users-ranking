...
The `number of followers` of users in Jordan on `2025/3/20 9:20 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
