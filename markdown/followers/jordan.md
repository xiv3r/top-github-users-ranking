...
The `number of followers` of users in Jordan on `2025/1/21 6:21 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
