...
The `number of followers` of users in Jordan on `2025/9/6 8:53 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
