...
The `number of followers` of users in Jordan on `2025/10/30 7:45 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
