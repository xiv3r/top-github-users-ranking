...
The `number of followers` of users in Jordan on `2025/4/2 10:05 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
