...
The `number of followers` of users in Jordan on `2026/2/27 8:17 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
