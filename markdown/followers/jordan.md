...
The `number of followers` of users in Jordan on `2025/9/12 5:54 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
