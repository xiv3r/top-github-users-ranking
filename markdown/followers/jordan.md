...
The `number of followers` of users in Jordan on `2025/8/30 11:31 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
