...
The `number of followers` of users in Jordan on `2026/1/17 5:48 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
