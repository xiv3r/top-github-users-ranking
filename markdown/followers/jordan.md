...
The `number of followers` of users in Jordan on `2025/1/3 5:51 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
