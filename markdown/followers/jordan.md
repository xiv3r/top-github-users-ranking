...
The `number of followers` of users in Jordan on `2026/5/16 11:32 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
