...
The `number of followers` of users in Jordan on `2025/11/13 7:06 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
