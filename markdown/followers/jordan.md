...
The `number of followers` of users in Jordan on `2025/2/10 10:47 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
