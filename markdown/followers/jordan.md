...
The `number of followers` of users in Jordan on `2025/1/1 8:26 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
