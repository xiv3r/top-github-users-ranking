...
The `number of followers` of users in Jordan on `2025/9/25 6:36 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
