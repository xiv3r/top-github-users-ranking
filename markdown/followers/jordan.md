...
The `number of followers` of users in Jordan on `2025/3/7 6:00 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
