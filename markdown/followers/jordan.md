...
The `number of followers` of users in Jordan on `2025/9/17 6:02 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
