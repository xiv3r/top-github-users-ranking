...
The `number of followers` of users in Jordan on `2025/3/29 2:51 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
