...
The `number of followers` of users in Jordan on `2026/2/19 4:20 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
