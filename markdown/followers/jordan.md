...
The `number of followers` of users in Jordan on `2025/10/1 5:15 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
