...
The `number of followers` of users in Jordan on `2026/1/21 3:12 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
