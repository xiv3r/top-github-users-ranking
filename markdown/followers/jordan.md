...
The `number of followers` of users in Jordan on `2025/10/10 7:49 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
