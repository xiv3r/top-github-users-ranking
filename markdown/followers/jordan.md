...
The `number of followers` of users in Jordan on `2025/12/28 2:21 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
