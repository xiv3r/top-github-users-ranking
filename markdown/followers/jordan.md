...
The `number of followers` of users in Jordan on `2025/7/27 9:38 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
