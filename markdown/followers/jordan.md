...
The `number of followers` of users in Jordan on `2025/2/13 10:27 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
