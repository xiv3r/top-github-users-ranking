...
The `number of followers` of users in Ecuador on `2025/10/1 8:07 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
