...
The `number of followers` of users in Ecuador on `2025/4/1 11:24 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
