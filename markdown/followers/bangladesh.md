...
The `number of followers` of users in Bangladesh on `2025/7/23 9:46 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
