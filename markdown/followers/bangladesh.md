...
The `number of followers` of users in Bangladesh on `2025/10/3 12:02 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
