...
The `number of followers` of users in Bangladesh on `2025/10/2 11:42 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
