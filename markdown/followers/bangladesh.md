...
The `number of followers` of users in Bangladesh on `2025/6/30 11:48 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
