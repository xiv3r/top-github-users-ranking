...
The `number of followers` of users in Bangladesh on `2025/9/28 3:50 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
