...
The `number of followers` of users in Bangladesh on `2025/8/1 9:00 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
