...
The `number of followers` of users in Bangladesh on `2025/2/8 5:29 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
