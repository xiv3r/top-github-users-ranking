...
The `number of followers` of users in Bangladesh on `2025/10/15 9:39 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
