...
The `number of followers` of users in Bangladesh on `2025/6/23 5:47 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
