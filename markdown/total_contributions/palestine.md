...
The `public contributions` and `private contributions` by users in Palestine on `2025/8/21 3:33 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
