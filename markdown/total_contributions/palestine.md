...
The `public contributions` and `private contributions` by users in Palestine on `2025/9/2 4:40 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
