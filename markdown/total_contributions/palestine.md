...
The `public contributions` and `private contributions` by users in Palestine on `2025/5/20 10:27 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
