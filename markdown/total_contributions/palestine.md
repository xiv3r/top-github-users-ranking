...
The `public contributions` and `private contributions` by users in Palestine on `2025/6/22 7:55 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
