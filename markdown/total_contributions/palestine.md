...
The `public contributions` and `private contributions` by users in Palestine on `2025/8/30 9:00 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
