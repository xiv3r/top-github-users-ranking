...
The `public contributions` and `private contributions` by users in Slovenia on `2025/11/23 9:41 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
