...
The `public contributions` and `private contributions` by users in Slovenia on `2025/8/13 4:03 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
