...
The `public contributions` and `private contributions` by users in Slovenia on `2025/12/29 1:57 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
