...
The `public contributions` and `private contributions` by users in Namibia on `2026/1/30 2:52 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
...
<table>
	...
	<tr>
		...
		<td>@identitytoday </td>
		<td><a href="https://twitter.com/BuiltBy_Justin">BuiltBy_Justin</a></td>
		<td>Namibia </td>
		<td>40</td>
		<td>2045</td>
	</tr>
