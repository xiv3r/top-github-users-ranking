...
The `public contributions` and `private contributions` by users in Namibia on `2025/7/21 10:47 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
...
<table>
	...
	<tr>
		<td>237</td>
		<td>
			<a href="https://github.com/Iamblok">
				<img src="https://avatars.githubusercontent.com/u/222002735?s=72&v=4" width="24" alt="Avatar of Iamblok"> Iamblok
			</a><br/>
			iamblok
		</td>
		<td>Northern Tech Industries </td>
		<td>No Twitter Username</td>
		<td>Namibia,Omafo</td>
		<td>5</td>
		<td>5</td>
