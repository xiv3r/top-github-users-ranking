...
The `public contributions` and `private contributions` by users in Namibia on `2025/9/7 6:21 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ceciliauusiku">
				<img src="https://avatars.githubusercontent.com/u/185852467?s=72&v=4" width="24" alt="Avatar of ceciliauusiku"> ceciliauusiku
			</a><br/>
			Cecilia Uusiku
		</td>
		<td>No Company</td>
