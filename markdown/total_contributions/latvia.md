...
The `public contributions` and `private contributions` by users in Latvia on `2026/5/4 1:16 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
