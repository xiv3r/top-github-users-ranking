...
The `public contributions` and `private contributions` by users in Latvia on `2025/2/8 7:39 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
