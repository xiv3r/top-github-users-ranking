...
The `public contributions` and `private contributions` by users in Hungary on `2025/1/3 2:00 PM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.
