...
The `public contributions` and `private contributions` by users in Hungary on `2025/12/31 2:30 AM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.
