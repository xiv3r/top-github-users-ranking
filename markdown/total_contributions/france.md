...
The `public contributions` and `private contributions` by users in France on `2025/3/20 2:31 AM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `927 users`  in France. You need at least `198 followers` to be on this list.
