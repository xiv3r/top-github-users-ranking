...
The `public contributions` and `private contributions` by users in France on `2025/4/13 9:33 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `924 users`  in France. You need at least `200 followers` to be on this list.
