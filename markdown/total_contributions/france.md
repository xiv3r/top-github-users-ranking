...
The `public contributions` and `private contributions` by users in France on `2025/8/30 6:21 AM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `923 users`  in France. You need at least `208 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jreinke">
				<img src="https://avatars.githubusercontent.com/u/598419?s=72&u=bb0ed79eb19e4576dd3e3bc6a5df3b6862bf6365&v=4" width="24" alt="Avatar of jreinke"> jreinke
			</a><br/>
			Johann Reinké
		</td>
		<td>Freelance </td>
