...
The `public contributions` and `private contributions` by users in France on `2025/5/28 5:07 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Dev-next-gen">
				<img src="https://avatars.githubusercontent.com/u/188639646?s=72&u=710c2868a364836edf590a5ad00eb43ef8ccc6dd&v=4" width="24" alt="Avatar of Dev-next-gen"> Dev-next-gen
			</a><br/>
			Leo C.
		</td>
		<td>No Company</td>
