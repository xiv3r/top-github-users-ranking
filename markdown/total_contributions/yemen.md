...
The `public contributions` and `private contributions` by users in Yemen on `2026/6/30 5:31 PM UTC`. This list contains users from `Yemen` and cities ` Sana'a`.
...
<table>
	...
	<tr>
		<td>538</td>
		<td>
			<a href="https://github.com/Pariq47">
				<img src="https://avatars.githubusercontent.com/u/171423576?s=72&v=4" width="24" alt="Avatar of Pariq47"> Pariq47
			</a><br/>
			عبدالله محمد عبدالله بامطرف 
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Yemen</td>
