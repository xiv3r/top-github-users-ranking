...
The `public contributions` and `private contributions` by users in Ghana on `2025/8/9 9:44 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
