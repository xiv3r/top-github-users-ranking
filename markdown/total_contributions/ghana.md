...
The `public contributions` and `private contributions` by users in Ghana on `2026/1/2 6:44 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
