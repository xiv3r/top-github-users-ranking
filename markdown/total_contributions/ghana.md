...
The `public contributions` and `private contributions` by users in Ghana on `2025/3/18 6:02 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
