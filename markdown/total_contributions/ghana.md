...
The `public contributions` and `private contributions` by users in Ghana on `2025/1/9 8:58 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
