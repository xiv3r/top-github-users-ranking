...
The `public contributions` and `private contributions` by users in Ghana on `2025/2/18 11:00 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
