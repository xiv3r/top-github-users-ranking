...
The `public contributions` and `private contributions` by users in Ghana on `2025/1/21 12:00 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
