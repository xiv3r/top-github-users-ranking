...
The `public contributions` and `private contributions` by users in Ghana on `2025/4/20 3:51 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
