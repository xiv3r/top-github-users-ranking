...
The `public contributions` and `private contributions` by users in Ecuador on `2025/10/3 11:49 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
