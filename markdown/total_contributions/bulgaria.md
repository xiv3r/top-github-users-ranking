...
The `public contributions` and `private contributions` by users in Bulgaria on `2026/1/24 7:02 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
