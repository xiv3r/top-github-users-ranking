...
The `public contributions` and `private contributions` by users in Bulgaria on `2026/6/15 4:01 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
