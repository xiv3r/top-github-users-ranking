...
The `public contributions` and `private contributions` by users in Rwanda on `2025/12/2 11:00 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
