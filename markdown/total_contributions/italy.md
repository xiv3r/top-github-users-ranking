...
The `public contributions` and `private contributions` by users in Italy on `2025/1/1 7:34 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Gigi-G">
				<img src="https://avatars.githubusercontent.com/u/45624102?s=72&u=e818f2ecf9b6f1293a828dac150d7051c1380a4e&v=4" width="24" alt="Avatar of Gigi-G"> Gigi-G
			</a><br/>
			Seminara Luigi
		</td>
