...
The `public contributions` and `private contributions` by users in Italy on `2025/5/8 7:42 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
