...
The `public contributions` and `private contributions` by users in Italy on `2025/1/19 9:24 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
...
<table>
	...
	<tr>
		<td>812</td>
		<td>
			<a href="https://github.com/s0sisochka">
				<img src="https://avatars.githubusercontent.com/u/177873602?s=72&u=d4391047cb328c7f304c5ee5b5db2d142ff673a6&v=4" width="24" alt="Avatar of s0sisochka"> s0sisochka
			</a><br/>
			Стася Сидоркова
		</td>
		<td>No Company</td>
