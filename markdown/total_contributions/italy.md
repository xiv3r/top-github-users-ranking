...
The `public contributions` and `private contributions` by users in Italy on `2025/1/25 6:53 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `959 users`  in Italy. You need at least `83 followers` to be on this list.
