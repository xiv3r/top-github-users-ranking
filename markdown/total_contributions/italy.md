...
The `public contributions` and `private contributions` by users in Italy on `2025/1/17 1:21 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
