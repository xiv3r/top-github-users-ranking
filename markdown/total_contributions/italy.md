...
The `public contributions` and `private contributions` by users in Italy on `2025/3/3 3:50 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
