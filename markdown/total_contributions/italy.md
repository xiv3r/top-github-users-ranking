...
The `public contributions` and `private contributions` by users in Italy on `2025/2/10 9:46 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `957 users`  in Italy. You need at least `83 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/rinodrummer">
				<img src="https://avatars.githubusercontent.com/u/6603220?s=72&u=3b57ebe187a2ce0ad46a62f3a171d3b43fa1b62c&v=4" width="24" alt="Avatar of rinodrummer"> rinodrummer
			</a><br/>
			Gennaro Landolfi
		</td>
		<td>No Company</td>
