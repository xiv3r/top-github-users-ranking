...
The `public contributions` and `private contributions` by users in Italy on `2025/5/14 9:35 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
...
<table>
	...
	<tr>
		...
		<td>@sourcesense </td>
		<td><a href="https://twitter.com/luckysideburn">luckysideburn</a></td>
		<td>Rome</td>
		<td>97</td>
		<td>99</td>
	</tr>
