...
The `public contributions` and `private contributions` by users in Italy on `2025/4/27 4:56 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
