...
The `public contributions` and `private contributions` by users in Italy on `2025/6/4 11:06 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
...
<table>
	...
	<tr>
		...
		<td>My Crew ✌️ @48gutfuck<br/>@myjunkie<br/>@joeyyoink<br/>@irieclinic<br/>@curetill<br/>@anthonycancelled<br/>@caiigulasaquarium<br/>@pha1non<br/></td>
		<td>No Twitter Username</td>
		<td>rome (ohio)</td>
		<td>5</td>
		<td>5</td>
