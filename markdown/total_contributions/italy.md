...
The `public contributions` and `private contributions` by users in Italy on `2025/2/24 10:30 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `957 users`  in Italy. You need at least `84 followers` to be on this list.
