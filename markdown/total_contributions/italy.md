...
The `public contributions` and `private contributions` by users in Italy on `2025/6/22 8:54 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
