...
The `public contributions` and `private contributions` by users in Italy on `2025/1/5 1:21 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Lucksi">
				<img src="https://avatars.githubusercontent.com/u/79308097?s=72&u=a51cb70d94cba2215226c9efd2bb18db999dce08&v=4" width="24" alt="Avatar of Lucksi"> Lucksi
			</a><br/>
			Luca Garofalo
		</td>
		<td>No Company</td>
