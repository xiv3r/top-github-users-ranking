...
The `public contributions` and `private contributions` by users in Egypt on `2025/5/24 5:01 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
