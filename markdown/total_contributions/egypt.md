...
The `public contributions` and `private contributions` by users in Egypt on `2025/4/18 10:58 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
