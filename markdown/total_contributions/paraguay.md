...
The `public contributions` and `private contributions` by users in Paraguay on `2025/8/10 1:03 PM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.
...
<table>
	...
	<tr>
		<td>578</td>
		<td>
			<a href="https://github.com/BenjaminTrigo">
				<img src="https://avatars.githubusercontent.com/u/192004079?s=72&v=4" width="24" alt="Avatar of BenjaminTrigo"> BenjaminTrigo
			</a><br/>
			Benjamin Trigo
		</td>
		<td>No Company</td>
