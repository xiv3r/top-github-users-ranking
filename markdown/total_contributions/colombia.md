...
The `public contributions` and `private contributions` by users in Colombia on `2025/8/17 2:53 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
