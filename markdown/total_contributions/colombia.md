...
The `public contributions` and `private contributions` by users in Colombia on `2025/12/17 10:41 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
