...
The `public contributions` and `private contributions` by users in Colombia on `2025/12/22 3:23 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/DevZyxlJs">
				<img src="https://avatars.githubusercontent.com/u/189913226?s=72&u=557144a510f914b1a94991f575421b3ed11b86fb&v=4" width="24" alt="Avatar of DevZyxlJs"> DevZyxlJs
			</a><br/>
			Ell Sarmiento 🦩
		</td>
		<td>Stellar </td>
