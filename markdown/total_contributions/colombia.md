...
The `public contributions` and `private contributions` by users in Colombia on `2025/3/17 10:41 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
...
<table>
	...
	<tr>
		<td>38</td>
		<td>
			<a href="https://github.com/DavidApril">
				<img src="https://avatars.githubusercontent.com/u/128427935?s=72&u=c2a1feeb7759610c1d3299dd778a4fa6866ea6e1&v=4" width="24" alt="Avatar of DavidApril"> DavidApril
			</a><br/>
			David Agámez
		</td>
		<td>No Company</td>
