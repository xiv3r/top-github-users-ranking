...
The `public contributions` and `private contributions` by users in Colombia on `2025/12/30 4:05 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/DevZyxlJs">
				<img src="https://avatars.githubusercontent.com/u/189913226?s=72&u=54e4470008e09ae2fde326fe2c1e32344ca0009c&v=4" width="24" alt="Avatar of DevZyxlJs"> DevZyxlJs
			</a><br/>
			Ell Sarmiento 🦩
		</td>
		<td>Stellar </td>
