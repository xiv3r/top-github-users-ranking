...
The `public contributions` and `private contributions` by users in Colombia on `2025/10/5 8:04 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jeanctech">
				<img src="https://avatars.githubusercontent.com/u/107894113?s=72&u=28d21c8cf1b4c7ab435a1f151ff9b9994a3c71cd&v=4" width="24" alt="Avatar of jeanctech"> jeanctech
			</a><br/>
			JeanCarlos Jimenez
		</td>
		<td>No Company</td>
