...
The `public contributions` and `private contributions` by users in Greece on `2025/9/22 2:55 PM UTC`. This list contains users from `Greece` and cities `Athens` `Thessaloniki` `Patras` `Heraklion` `Ioannina` `Pireas` `Volos` `Agrinio`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/eakirtas">
				<img src="https://avatars.githubusercontent.com/u/10010230?s=72&u=2d25eb58aa81d68174bf5697f76dd970700376fe&v=4" width="24" alt="Avatar of eakirtas"> eakirtas
			</a><br/>
			Manos Kirtas
		</td>
