...
The `public contributions` and `private contributions` by users in Lithuania on `2025/10/14 3:35 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
