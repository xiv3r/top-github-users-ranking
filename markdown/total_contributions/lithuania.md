...
The `public contributions` and `private contributions` by users in Lithuania on `2025/1/29 4:37 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
