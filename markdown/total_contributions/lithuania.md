...
The `public contributions` and `private contributions` by users in Lithuania on `2025/3/7 7:52 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
