...
The `public contributions` and `private contributions` by users in Lithuania on `2025/3/20 10:59 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
