...
The `public contributions` and `private contributions` by users in Lithuania on `2025/9/29 2:49 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
