...
The `public contributions` and `private contributions` by users in Lithuania on `2024/12/31 1:59 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
