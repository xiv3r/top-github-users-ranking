...
The `public contributions` and `private contributions` by users in Lithuania on `2026/2/11 10:11 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
