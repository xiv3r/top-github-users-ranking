...
The `public contributions` and `private contributions` by users in Lithuania on `2025/8/28 8:50 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
