...
The `public contributions` and `private contributions` by users in Lithuania on `2025/12/31 11:30 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
