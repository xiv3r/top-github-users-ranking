...
The `public contributions` and `private contributions` by users in Lithuania on `2025/3/1 10:46 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
