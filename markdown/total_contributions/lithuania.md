...
The `public contributions` and `private contributions` by users in Lithuania on `2025/4/25 10:22 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
