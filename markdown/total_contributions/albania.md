...
The `public contributions` and `private contributions` by users in Albania on `2025/7/20 5:32 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
