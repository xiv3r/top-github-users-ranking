...
The `public contributions` and `private contributions` by users in Albania on `2025/8/11 8:02 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/joanskenderi">
				<img src="https://avatars.githubusercontent.com/u/207873570?s=72&u=0bc21a7c5866f2878d43b8ce358a7bf6dbb9a0c3&v=4" width="24" alt="Avatar of joanskenderi"> joanskenderi
			</a><br/>
			Joan Skënderi
		</td>
		<td>No Company</td>
