...
The `public contributions` and `private contributions` by users in Albania on `2025/12/16 7:06 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
