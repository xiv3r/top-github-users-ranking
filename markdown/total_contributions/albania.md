...
The `public contributions` and `private contributions` by users in Albania on `2025/8/8 7:06 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
...
<table>
	...
	<tr>
		...
		<td>@deltatre-innovation @deltatre-vxp </td>
		<td>No Twitter Username</td>
		<td>Tirana, Albania</td>
		<td>198</td>
		<td>6579</td>
