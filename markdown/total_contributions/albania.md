...
The `public contributions` and `private contributions` by users in Albania on `2026/1/4 11:22 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
