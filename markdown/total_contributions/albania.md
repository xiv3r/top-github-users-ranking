...
The `public contributions` and `private contributions` by users in Albania on `2025/11/23 5:59 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
