...
The `public contributions` and `private contributions` by users in Albania on `2025/8/24 2:31 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
