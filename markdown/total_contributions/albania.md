...
The `public contributions` and `private contributions` by users in Albania on `2025/11/12 1:11 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
