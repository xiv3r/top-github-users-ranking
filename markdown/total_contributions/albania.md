...
The `public contributions` and `private contributions` by users in Albania on `2025/12/3 5:08 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
