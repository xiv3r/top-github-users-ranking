...
The `public contributions` and `private contributions` by users in Albania on `2026/1/31 7:36 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
