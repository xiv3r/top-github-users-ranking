...
The `public contributions` and `private contributions` by users in Albania on `2025/3/17 2:04 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
