...
The `public contributions` and `private contributions` by users in Albania on `2026/3/12 7:36 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AndiXplorer">
				<img src="https://avatars.githubusercontent.com/u/44722617?s=72&u=ce2697e52d46947d4903a45d89064273dd282dfb&v=4" width="24" alt="Avatar of AndiXplorer"> AndiXplorer
			</a><br/>
			Young Moon
		</td>
		<td>Fynnza </td>
