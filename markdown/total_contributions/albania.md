...
The `public contributions` and `private contributions` by users in Albania on `2025/8/17 12:00 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/joanskenderi">
				<img src="https://avatars.githubusercontent.com/u/207873570?s=72&u=e9d77a579ca9058cc29728291f0e06fd25fb3c0d&v=4" width="24" alt="Avatar of joanskenderi"> joanskenderi
			</a><br/>
			Joan Skënderi
		</td>
		<td>No Company</td>
