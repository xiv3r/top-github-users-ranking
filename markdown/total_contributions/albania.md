...
The `public contributions` and `private contributions` by users in Albania on `2025/11/2 5:16 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AndiXplorer">
				<img src="https://avatars.githubusercontent.com/u/44722617?s=72&u=4e0276e2e5158133677a8ee18a19124157425ae3&v=4" width="24" alt="Avatar of AndiXplorer"> AndiXplorer
			</a><br/>
			Young Moon
		</td>
		<td>Fynnza </td>
