...
The `public contributions` and `private contributions` by users in Albania on `2025/6/21 10:58 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AndiXplorer">
				<img src="https://avatars.githubusercontent.com/u/44722617?s=72&u=58b5c260df5c49fdc5a919b77d533b6ae4ea1ddb&v=4" width="24" alt="Avatar of AndiXplorer"> AndiXplorer
			</a><br/>
			Young Moon
		</td>
		<td>Fynnza </td>
