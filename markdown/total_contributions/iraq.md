...
The `public contributions` and `private contributions` by users in Iraq on `2024/12/30 8:51 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
