...
The `public contributions` and `private contributions` by users in Iraq on `2026/2/19 8:10 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
