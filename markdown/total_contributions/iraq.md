...
The `public contributions` and `private contributions` by users in Iraq on `2025/1/9 12:09 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
