...
The `public contributions` and `private contributions` by users in Iraq on `2025/6/2 3:02 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
