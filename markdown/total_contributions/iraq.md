...
The `public contributions` and `private contributions` by users in Iraq on `2025/8/9 1:28 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
