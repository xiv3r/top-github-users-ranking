...
The `public contributions` and `private contributions` by users in Iraq on `2026/7/19 5:36 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
