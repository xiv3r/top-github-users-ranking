...
The `public contributions` and `private contributions` by users in Iraq on `2026/8/29 2:29 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
