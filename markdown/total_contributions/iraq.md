...
The `public contributions` and `private contributions` by users in Iraq on `2026/3/24 5:39 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
