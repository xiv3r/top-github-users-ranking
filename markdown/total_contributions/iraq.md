...
The `public contributions` and `private contributions` by users in Iraq on `2025/4/18 3:52 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
