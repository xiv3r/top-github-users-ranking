...
The `public contributions` and `private contributions` by users in Iraq on `2025/8/15 3:08 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
