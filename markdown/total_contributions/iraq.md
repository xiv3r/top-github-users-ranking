...
The `public contributions` and `private contributions` by users in Iraq on `2025/7/17 8:27 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
