...
The `public contributions` and `private contributions` by users in Iraq on `2025/12/23 5:06 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
