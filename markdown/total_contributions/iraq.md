...
The `public contributions` and `private contributions` by users in Iraq on `2025/11/27 7:08 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
