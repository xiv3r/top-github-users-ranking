...
The `public contributions` and `private contributions` by users in Iraq on `2025/10/5 4:52 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
