...
The `public contributions` and `private contributions` by users in Iraq on `2026/6/20 10:48 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
