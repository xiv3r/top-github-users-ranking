...
The `public contributions` and `private contributions` by users in Iraq on `2026/5/16 3:41 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
