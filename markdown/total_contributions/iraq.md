...
The `public contributions` and `private contributions` by users in Iraq on `2025/9/29 10:00 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
