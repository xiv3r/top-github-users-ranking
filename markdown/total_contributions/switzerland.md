...
The `public contributions` and `private contributions` by users in Switzerland on `2025/12/13 4:43 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
