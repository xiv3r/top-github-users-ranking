...
The `public contributions` and `private contributions` by users in Switzerland on `2026/1/23 10:03 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
