...
The `public contributions` and `private contributions` by users in Switzerland on `2025/4/5 1:00 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
