...
The `public contributions` and `private contributions` by users in Switzerland on `2024/12/31 4:44 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
