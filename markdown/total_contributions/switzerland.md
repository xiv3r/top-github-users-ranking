...
The `public contributions` and `private contributions` by users in Switzerland on `2025/1/20 4:24 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
