...
The `public contributions` and `private contributions` by users in Armenia on `2025/12/16 8:57 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
