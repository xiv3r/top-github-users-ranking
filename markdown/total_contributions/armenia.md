...
The `public contributions` and `private contributions` by users in Armenia on `2025/1/12 2:36 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
