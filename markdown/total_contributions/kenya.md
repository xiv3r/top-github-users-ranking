...
The `public contributions` and `private contributions` by users in Kenya on `2025/4/7 9:56 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
