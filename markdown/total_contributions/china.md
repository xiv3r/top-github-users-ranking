...
The `public contributions` and `private contributions` by users in China on `2025/4/24 7:35 PM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `936 users`  in China. You need at least `763 followers` to be on this list.
