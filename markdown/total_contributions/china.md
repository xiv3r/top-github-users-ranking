...
The `public contributions` and `private contributions` by users in China on `2025/7/14 8:58 AM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.
...
<table>
	...
	<tr>
		<td>128</td>
		<td>
			<a href="https://github.com/fumiama">
		...
		<td><a href="https://twitter.com/MinamotoFumiama">MinamotoFumiama</a></td>
		<td>Xi'an, China</td>
		<td>928</td>
		<td>1277</td>
	</tr>
