...
The `public contributions` and `private contributions` by users in Bahrain on `2026/6/14 1:49 AM UTC`. This list contains users from `Bahrain` and cities `Nassau` `Riffa` `Muharraq`.
...
<table>
	...
	<tr>
		<td>508</td>
		<td>
			<a href="https://github.com/iampolystud1">
				<img src="https://avatars.githubusercontent.com/u/290895618?s=72&v=4" width="24" alt="Avatar of iampolystud1"> iampolystud1
			</a><br/>
			Ali Alsaffar
		</td>
		<td>Bahrain Polytechnic </td>
