...
The `public contributions` and `private contributions` by users in Bahrain on `2025/5/23 5:02 PM UTC`. This list contains users from `Bahrain` and cities `Nassau` `Riffa` `Muharraq`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Danab19">
				<img src="https://avatars.githubusercontent.com/u/127206851?s=72&v=4" width="24" alt="Avatar of Danab19"> Danab19
			</a><br/>
			Dana Barhoom
		</td>
		<td>No Company</td>
