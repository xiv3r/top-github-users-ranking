...
The `public contributions` and `private contributions` by users in Venezuela on `2025/7/19 9:25 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
