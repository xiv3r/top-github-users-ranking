...
The `public contributions` and `private contributions` by users in Venezuela on `2026/2/15 8:58 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
