...
The `public contributions` and `private contributions` by users in Venezuela on `2025/6/23 11:28 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
