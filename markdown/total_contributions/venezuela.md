...
The `public contributions` and `private contributions` by users in Venezuela on `2025/5/7 7:40 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
