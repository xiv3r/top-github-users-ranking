...
The `public contributions` and `private contributions` by users in Venezuela on `2025/12/13 8:59 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
