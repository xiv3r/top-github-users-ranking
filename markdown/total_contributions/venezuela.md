...
The `public contributions` and `private contributions` by users in Venezuela on `2026/1/10 9:30 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
