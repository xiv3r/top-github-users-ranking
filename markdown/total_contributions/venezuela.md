...
The `public contributions` and `private contributions` by users in Venezuela on `2026/1/13 3:59 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
