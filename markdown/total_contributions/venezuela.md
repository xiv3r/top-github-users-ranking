...
The `public contributions` and `private contributions` by users in Venezuela on `2025/2/18 7:43 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
