...
The `public contributions` and `private contributions` by users in Syria on `2025/10/28 7:07 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
