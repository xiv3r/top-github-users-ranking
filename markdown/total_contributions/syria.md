...
The `public contributions` and `private contributions` by users in Syria on `2025/12/5 11:31 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
