...
The `public contributions` and `private contributions` by users in Syria on `2025/1/12 7:55 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
