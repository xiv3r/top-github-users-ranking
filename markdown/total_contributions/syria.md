...
The `public contributions` and `private contributions` by users in Syria on `2025/10/22 4:39 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
