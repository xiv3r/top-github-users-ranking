...
The `public contributions` and `private contributions` by users in Syria on `2025/10/2 2:35 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
