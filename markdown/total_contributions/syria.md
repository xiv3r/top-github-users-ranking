...
The `public contributions` and `private contributions` by users in Syria on `2025/12/8 7:40 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
