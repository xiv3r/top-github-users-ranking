...
The `public contributions` and `private contributions` by users in Syria on `2025/8/4 9:45 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
