...
The `public contributions` and `private contributions` by users in Syria on `2024/12/31 4:53 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
