...
The `public contributions` and `private contributions` by users in Syria on `2025/7/25 4:40 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
