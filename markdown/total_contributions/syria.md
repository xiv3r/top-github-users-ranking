...
The `public contributions` and `private contributions` by users in Syria on `2025/12/16 9:22 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
