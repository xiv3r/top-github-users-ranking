...
The `public contributions` and `private contributions` by users in Syria on `2025/11/16 10:37 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
