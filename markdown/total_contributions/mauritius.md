...
The `public contributions` and `private contributions` by users in Mauritius on `2025/5/22 10:59 AM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.
...
<table>
	...
	<tr>
		<td>437</td>
		<td>
			<a href="https://github.com/NivxshEdu">
				<img src="https://avatars.githubusercontent.com/u/208388144?s=72&v=4" width="24" alt="Avatar of NivxshEdu"> NivxshEdu
			</a><br/>
			Nivesh Kumar Choytun
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Mauritius</td>
