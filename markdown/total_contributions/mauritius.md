...
The `public contributions` and `private contributions` by users in Mauritius on `2025/8/28 11:42 AM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `904 users`  in Mauritius. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/legenie1">
				<img src="https://avatars.githubusercontent.com/u/72471055?s=72&u=6e593207abddef370ec954fc3866269497be28ef&v=4" width="24" alt="Avatar of legenie1"> legenie1
			</a><br/>
			Moffo Sergeo
		</td>
		<td>Accenture </td>
