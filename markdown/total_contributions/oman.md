...
The `public contributions` and `private contributions` by users in Oman on `2025/10/28 8:36 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/fahad-m-b">
				<img src="https://avatars.githubusercontent.com/u/141445845?s=72&v=4" width="24" alt="Avatar of fahad-m-b"> fahad-m-b
			</a><br/>
			Fahad BaOmar
		</td>
		<td>No Company</td>
