...
The `public contributions` and `private contributions` by users in Oman on `2025/12/15 6:42 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/talal3idarus">
				<img src="https://avatars.githubusercontent.com/u/127446164?s=72&v=4" width="24" alt="Avatar of talal3idarus"> talal3idarus
			</a><br/>
			talal3idarus
		</td>
