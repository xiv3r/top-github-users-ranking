...
The `public contributions` and `private contributions` by users in Oman on `2026/2/21 6:08 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
...
<table>
	...
	<tr>
		...
		<td>The Open Core Foundation<br/></td>
		<td>No Twitter Username</td>
		<td>OMAN/USA</td>
		<td>73</td>
		<td>248</td>
