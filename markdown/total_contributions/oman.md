...
The `public contributions` and `private contributions` by users in Oman on `2025/9/15 9:02 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/n4er">
				<img src="https://avatars.githubusercontent.com/u/167068892?s=72&v=4" width="24" alt="Avatar of n4er"> n4er
			</a><br/>
			Nasser Al-Musalhi
		</td>
		<td>Unemployed </td>
