...
The `public contributions` and `private contributions` by users in Oman on `2026/1/25 4:43 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/alialharassi1">
				<img src="https://avatars.githubusercontent.com/u/53556097?s=72&v=4" width="24" alt="Avatar of alialharassi1"> alialharassi1
			</a><br/>
			Ali Alharrasi
		</td>
		<td>@rihal-om  </td>
	...
	<tr>
		...
		<td>Invospark, Deepastra, Zariq </td>
		<td>No Twitter Username</td>
		<td>Muscat, OM.</td>
		<td>207</td>
		<td>207</td>
