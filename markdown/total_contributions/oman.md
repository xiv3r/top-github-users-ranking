...
The `public contributions` and `private contributions` by users in Oman on `2025/12/5 1:05 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
...
<table>
	...
	<tr>
		<td>299</td>
		<td>
			<a href="https://github.com/mahmoodalhosni">
				<img src="https://avatars.githubusercontent.com/u/155448924?s=72&u=5fa3db935f52660bba8a92ee803c76e5ef1e271b&v=4" width="24" alt="Avatar of mahmoodalhosni"> mahmoodalhosni
			</a><br/>
			Mahmood Al-Hosni
		</td>
		<td>Full Stack Solo Dev<br/></td>
		<td>No Twitter Username</td>
		<td>Muscat, Oman</td>
		<td>32</td>
		<td>32</td>
