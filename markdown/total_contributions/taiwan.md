...
The `public contributions` and `private contributions` by users in Taiwan on `2025/4/28 9:40 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
