...
The `public contributions` and `private contributions` by users in Taiwan on `2025/9/14 2:29 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
