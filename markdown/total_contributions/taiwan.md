...
The `public contributions` and `private contributions` by users in Taiwan on `2025/10/13 11:00 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
