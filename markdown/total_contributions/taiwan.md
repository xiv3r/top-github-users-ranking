...
The `public contributions` and `private contributions` by users in Taiwan on `2025/10/1 5:07 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
