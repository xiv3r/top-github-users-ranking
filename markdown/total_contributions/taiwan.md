...
The `public contributions` and `private contributions` by users in Taiwan on `2025/8/20 5:03 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
