...
The `public contributions` and `private contributions` by users in Taiwan on `2025/11/5 2:59 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
