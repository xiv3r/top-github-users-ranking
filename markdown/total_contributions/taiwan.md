...
The `public contributions` and `private contributions` by users in Taiwan on `2025/12/4 7:40 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
