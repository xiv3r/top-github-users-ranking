...
The `public contributions` and `private contributions` by users in Finland on `2025/2/2 10:45 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
