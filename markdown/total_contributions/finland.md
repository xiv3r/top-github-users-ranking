...
The `public contributions` and `private contributions` by users in Finland on `2025/11/26 11:25 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
...
<table>
	...
	<tr>
		...
		<td>@coresync-co @joinfides @domain76 @theaipetcompany<br/>@getsieutoc<br/>@lakihelppi<br/>@influxify<br/>@mortgage-assistant<br/></td>
		<td>No Twitter Username</td>
