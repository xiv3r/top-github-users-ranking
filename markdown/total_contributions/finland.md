...
The `public contributions` and `private contributions` by users in Finland on `2024/12/30 5:23 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
