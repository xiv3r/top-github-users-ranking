...
The `public contributions` and `private contributions` by users in Finland on `2025/3/18 4:47 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
