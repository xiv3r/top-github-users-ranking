...
The `public contributions` and `private contributions` by users in Finland on `2025/11/3 10:37 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/erikparkhomenko">
				<img src="https://avatars.githubusercontent.com/u/99688743?s=72&u=edfad7aa43f7a990f4940582f911b16fbb361580&v=4" width="24" alt="Avatar of erikparkhomenko"> erikparkhomenko
			</a><br/>
			Erik
		</td>
		<td>No Company</td>
