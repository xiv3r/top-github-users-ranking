...
The `public contributions` and `private contributions` by users in Finland on `2025/11/5 7:55 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `927 users`  in Finland. You need at least `50 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/namvdo">
				<img src="https://avatars.githubusercontent.com/u/34415207?s=72&u=bceaf73ec9d1b72dc4d07207d29c3ee113a5d064&v=4" width="24" alt="Avatar of namvdo"> namvdo
			</a><br/>
			Nam V. Do
		</td>
