...
The `public contributions` and `private contributions` by users in Finland on `2025/2/15 10:30 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
