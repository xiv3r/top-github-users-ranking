...
The `public contributions` and `private contributions` by users in Finland on `2025/10/29 9:32 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
