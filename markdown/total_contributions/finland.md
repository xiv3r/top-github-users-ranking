...
The `public contributions` and `private contributions` by users in Finland on `2025/11/12 8:40 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
...
<table>
	...
	<tr>
		...
		<td>@joinfides @domain76 @theaipetcompany @getsieutoc<br/>@lakihelppi<br/>@influxify<br/>@mortgage-assistant<br/></td>
		<td>No Twitter Username</td>
