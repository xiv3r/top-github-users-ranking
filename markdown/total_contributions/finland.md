...
The `public contributions` and `private contributions` by users in Finland on `2025/8/15 9:37 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
