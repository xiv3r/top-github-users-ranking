...
The `public contributions` and `private contributions` by users in Finland on `2025/9/6 3:10 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
