...
The `public contributions` and `private contributions` by users in Finland on `2025/6/30 10:37 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
