...
The `public contributions` and `private contributions` by users in Finland on `2025/1/11 7:58 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
