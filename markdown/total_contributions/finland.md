...
The `public contributions` and `private contributions` by users in Finland on `2026/1/24 4:56 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `924 users`  in Finland. You need at least `51 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/michael-andreuzza">
				<img src="https://avatars.githubusercontent.com/u/34077176?s=72&u=fc324a7f3eecfacae230ca566dc5f33052881f47&v=4" width="24" alt="Avatar of michael-andreuzza"> michael-andreuzza
			</a><br/>
			Michael Andreuzza
		</td>
		<td>Unwrapped </td>
