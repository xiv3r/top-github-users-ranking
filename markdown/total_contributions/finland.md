...
The `public contributions` and `private contributions` by users in Finland on `2025/9/22 12:56 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `930 users`  in Finland. You need at least `50 followers` to be on this list.
