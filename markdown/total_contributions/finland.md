...
The `public contributions` and `private contributions` by users in Finland on `2026/7/5 6:46 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
