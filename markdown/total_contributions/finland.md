...
The `public contributions` and `private contributions` by users in Finland on `2026/1/5 7:37 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
