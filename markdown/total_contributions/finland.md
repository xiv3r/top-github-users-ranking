...
The `public contributions` and `private contributions` by users in Finland on `2025/2/13 5:17 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
