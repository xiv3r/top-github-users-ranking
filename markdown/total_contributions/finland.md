...
The `public contributions` and `private contributions` by users in Finland on `2026/2/18 1:58 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/edwinsamar">
				<img src="https://avatars.githubusercontent.com/u/3524061?s=72&u=bbb6b292cb6270dc39c93cc0dfb563d7a0e95053&v=4" width="24" alt="Avatar of edwinsamar"> edwinsamar
			</a><br/>
			Edwin Samar
		</td>
		<td>@sievoofficial </td>
