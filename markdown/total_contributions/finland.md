...
The `public contributions` and `private contributions` by users in Finland on `2026/1/8 10:59 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
