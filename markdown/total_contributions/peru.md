...
The `public contributions` and `private contributions` by users in Peru on `2025/11/20 8:43 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/msolarig">
				<img src="https://avatars.githubusercontent.com/u/149914649?s=72&u=24bcfc8b5f8ad8b6aaabdc71a42e7b3d5ee34214&v=4" width="24" alt="Avatar of msolarig"> msolarig
			</a><br/>
			Matías Solari
		</td>
		<td>No Company</td>
