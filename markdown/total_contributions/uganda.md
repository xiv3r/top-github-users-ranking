...
The `public contributions` and `private contributions` by users in Uganda on `2024/12/31 5:59 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
