...
The `public contributions` and `private contributions` by users in Uganda on `2025/5/13 4:51 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
