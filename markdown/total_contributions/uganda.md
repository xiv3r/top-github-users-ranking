...
The `public contributions` and `private contributions` by users in Uganda on `2025/12/11 4:33 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
