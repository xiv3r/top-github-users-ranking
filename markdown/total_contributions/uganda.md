...
The `public contributions` and `private contributions` by users in Uganda on `2025/12/24 2:02 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
