...
The `public contributions` and `private contributions` by users in Uganda on `2025/11/9 11:42 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
