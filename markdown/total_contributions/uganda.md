...
The `public contributions` and `private contributions` by users in Uganda on `2025/12/21 7:03 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
