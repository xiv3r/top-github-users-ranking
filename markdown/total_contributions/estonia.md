...
The `public contributions` and `private contributions` by users in Estonia on `2025/8/15 8:45 AM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.
