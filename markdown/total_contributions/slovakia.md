...
The `public contributions` and `private contributions` by users in Slovakia on `2025/8/7 10:22 AM UTC`. This list contains users from `Slovakia` and cities `Bratislava` `Košice`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/trapfault">
				<img src="https://avatars.githubusercontent.com/u/152599623?s=72&v=4" width="24" alt="Avatar of trapfault"> trapfault
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
