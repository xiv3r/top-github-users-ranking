...
The `public contributions` and `private contributions` by users in Georgia on `2025/10/27 1:00 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
