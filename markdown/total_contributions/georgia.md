...
The `public contributions` and `private contributions` by users in Georgia on `2025/9/22 1:53 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
