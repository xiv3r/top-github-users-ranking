...
The `public contributions` and `private contributions` by users in Georgia on `2025/10/3 2:37 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
