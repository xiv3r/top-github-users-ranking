...
The `public contributions` and `private contributions` by users in Georgia on `2025/12/12 9:10 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
