...
The `public contributions` and `private contributions` by users in Georgia on `2025/11/12 9:35 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
