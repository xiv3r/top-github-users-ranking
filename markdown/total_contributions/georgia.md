...
The `public contributions` and `private contributions` by users in Georgia on `2025/5/19 4:20 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
