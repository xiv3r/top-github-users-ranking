...
The `public contributions` and `private contributions` by users in Georgia on `2025/8/12 8:45 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
