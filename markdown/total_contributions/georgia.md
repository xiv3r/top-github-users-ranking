...
The `public contributions` and `private contributions` by users in Georgia on `2025/9/1 10:03 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
