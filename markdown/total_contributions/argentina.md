...
The `public contributions` and `private contributions` by users in Argentina on `2025/5/21 4:59 AM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/crscardellino">
				<img src="https://avatars.githubusercontent.com/u/2011781?s=72&u=91a41f326d97a06ef9bd7f86159041df25ed917e&v=4" width="24" alt="Avatar of crscardellino"> crscardellino
			</a><br/>
			Cristian Cardellino
		</td>
		<td>Eclypsium </td>
