...
The `public contributions` and `private contributions` by users in Argentina on `2025/10/31 5:45 PM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.
...
<table>
	...
	<tr>
		<td>553</td>
		<td>
			<a href="https://github.com/juliannParra99">
				<img src="https://avatars.githubusercontent.com/u/104667764?s=72&u=9815f274f0779de731e6ee3ad184d6ba429c9de6&v=4" width="24" alt="Avatar of juliannParra99"> juliannParra99
			</a><br/>
			Julián Parra
		</td>
		<td>No Company</td>
