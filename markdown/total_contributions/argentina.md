...
The `public contributions` and `private contributions` by users in Argentina on `2025/3/24 11:25 PM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `960 users`  in Argentina. You need at least `52 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jd-apprentice">
				<img src="https://avatars.githubusercontent.com/u/68082746?s=72&u=8712f1aed04edd7003982984368701379ce35896&v=4" width="24" alt="Avatar of jd-apprentice"> jd-apprentice
			</a><br/>
			jd
		</td>
		<td>@dyallab </td>
