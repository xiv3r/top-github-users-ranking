...
The `public contributions` and `private contributions` by users in Argentina on `2025/9/28 2:23 PM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `956 users`  in Argentina. You need at least `56 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/kzu">
				<img src="https://avatars.githubusercontent.com/u/169707?s=72&u=6e292eea6cbcfd81ef540da0477c386994d9604b&v=4" width="24" alt="Avatar of kzu"> kzu
			</a><br/>
			Daniel Cazzulino
		</td>
		<td>@devlooped </td>
