...
The `public contributions` and `private contributions` by users in Turkey on `2025/8/7 4:30 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
