...
The `public contributions` and `private contributions` by users in Turkey on `2025/11/23 1:41 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
