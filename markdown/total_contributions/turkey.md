...
The `public contributions` and `private contributions` by users in Turkey on `2026/2/22 5:04 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
