...
The `public contributions` and `private contributions` by users in Turkey on `2026/1/26 6:36 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
