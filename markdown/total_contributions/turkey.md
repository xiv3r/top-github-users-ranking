...
The `public contributions` and `private contributions` by users in Turkey on `2025/10/15 1:33 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
