...
The `public contributions` and `private contributions` by users in Turkey on `2025/11/14 9:26 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
