...
The `public contributions` and `private contributions` by users in Turkey on `2025/3/4 1:31 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
