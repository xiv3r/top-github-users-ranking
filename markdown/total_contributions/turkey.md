...
The `public contributions` and `private contributions` by users in Turkey on `2026/1/1 1:34 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
