...
The `public contributions` and `private contributions` by users in Norway on `2025/9/10 9:09 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
