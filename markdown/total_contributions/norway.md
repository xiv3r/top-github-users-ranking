...
The `public contributions` and `private contributions` by users in Norway on `2025/10/10 6:33 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
