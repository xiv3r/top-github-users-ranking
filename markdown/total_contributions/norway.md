...
The `public contributions` and `private contributions` by users in Norway on `2025/5/18 4:19 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
