...
The `public contributions` and `private contributions` by users in Norway on `2026/2/5 6:43 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
