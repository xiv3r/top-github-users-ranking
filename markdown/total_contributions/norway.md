...
The `public contributions` and `private contributions` by users in Norway on `2025/9/25 5:55 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
