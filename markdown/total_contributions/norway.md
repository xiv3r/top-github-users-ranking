...
The `public contributions` and `private contributions` by users in Norway on `2025/11/18 7:04 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
