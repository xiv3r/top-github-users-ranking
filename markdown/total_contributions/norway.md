...
The `public contributions` and `private contributions` by users in Norway on `2026/6/25 3:33 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
