...
The `public contributions` and `private contributions` by users in Uruguay on `2025/12/16 3:06 PM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Caliburno">
				<img src="https://avatars.githubusercontent.com/u/170189479?s=72&v=4" width="24" alt="Avatar of Caliburno"> Caliburno
			</a><br/>
			Darío Buffa
		</td>
		<td>No Company</td>
