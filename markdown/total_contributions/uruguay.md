...
The `public contributions` and `private contributions` by users in Uruguay on `2025/7/6 7:00 PM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
