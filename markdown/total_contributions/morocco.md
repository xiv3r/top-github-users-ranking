...
The `public contributions` and `private contributions` by users in Morocco on `2025/12/18 12:08 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/origin-ayoub">
				<img src="https://avatars.githubusercontent.com/u/85124779?s=72&u=1e5c8c0235739e8945386d3fc806b32c26629b1e&v=4" width="24" alt="Avatar of origin-ayoub"> origin-ayoub
			</a><br/>
			Ayoub
		</td>
		<td>No Company</td>
