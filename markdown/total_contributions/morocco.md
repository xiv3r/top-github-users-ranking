...
The `public contributions` and `private contributions` by users in Morocco on `2025/8/28 1:56 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/badriyassine">
				<img src="https://avatars.githubusercontent.com/u/199480332?s=72&u=88ee5b7adfbbd0aa94b3e8e72228a29db3626b4c&v=4" width="24" alt="Avatar of badriyassine"> badriyassine
			</a><br/>
			Badri Yassine
		</td>
		<td>No Company</td>
