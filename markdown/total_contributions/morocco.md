...
The `public contributions` and `private contributions` by users in Morocco on `2025/3/3 9:50 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/zakaria-123kardache">
				<img src="https://avatars.githubusercontent.com/u/89345718?s=72&u=f91d3e430200061613eb1cae67209dc29af1f8a8&v=4" width="24" alt="Avatar of zakaria-123kardache"> zakaria-123kardache
			</a><br/>
			Kardache Zakaria 
		</td>
		<td>Youcode </td>
