...
The `public contributions` and `private contributions` by users in Morocco on `2025/9/27 5:41 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/badriyassine">
				<img src="https://avatars.githubusercontent.com/u/199480332?s=72&u=64be1224bbb9f7e43371c316eb340cd3400840fc&v=4" width="24" alt="Avatar of badriyassine"> badriyassine
			</a><br/>
			BADRI YASSINE
		</td>
		<td>No Company</td>
