...
The `public contributions` and `private contributions` by users in Morocco on `2025/10/30 3:41 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/yamilobt8">
				<img src="https://avatars.githubusercontent.com/u/123247514?s=72&u=2d994a004122ba35701afaa9a9a1a45bfeeb7cea&v=4" width="24" alt="Avatar of yamilobt8"> yamilobt8
			</a><br/>
			Link
		</td>
		<td>No Company</td>
