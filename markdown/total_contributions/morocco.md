...
The `public contributions` and `private contributions` by users in Morocco on `2025/4/14 11:47 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/aelmaar">
				<img src="https://avatars.githubusercontent.com/u/53582327?s=72&u=e3bd2256631836cb34b6b8dfbc6ec5cfbf1eacc4&v=4" width="24" alt="Avatar of aelmaar"> aelmaar
			</a><br/>
			Anouar El Maaroufi
		</td>
		<td>No Company</td>
