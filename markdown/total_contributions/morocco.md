...
The `public contributions` and `private contributions` by users in Morocco on `2026/1/15 5:47 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Hasnaaaae">
				<img src="https://avatars.githubusercontent.com/u/125884813?s=72&u=587e1cb0302e751e5fc1f629907a4ef03331871f&v=4" width="24" alt="Avatar of Hasnaaaae"> Hasnaaaae
			</a><br/>
			Hasnae 🍒
		</td>
		<td>Zone01oujda </td>
