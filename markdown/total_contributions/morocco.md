...
The `public contributions` and `private contributions` by users in Morocco on `2025/9/4 6:06 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AmraniCh">
				<img src="https://avatars.githubusercontent.com/u/49124992?s=72&u=dedf2347adf06e22a17f523d26e72b6ead2814ff&v=4" width="24" alt="Avatar of AmraniCh"> AmraniCh
			</a><br/>
			Shakir El Amrani
		</td>
		<td>No Company</td>
