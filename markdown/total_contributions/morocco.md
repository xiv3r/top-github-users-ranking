...
The `public contributions` and `private contributions` by users in Morocco on `2025/5/15 7:31 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AvogatoWizardWhisker">
				<img src="https://avatars.githubusercontent.com/u/89489853?s=72&u=27a97d47211a0c0b202e6ee5edd454001e664735&v=4" width="24" alt="Avatar of AvogatoWizardWhisker"> AvogatoWizardWhisker
			</a><br/>
			Solus Gameolus
		</td>
		<td>No Company</td>
