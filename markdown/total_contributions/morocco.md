...
The `public contributions` and `private contributions` by users in Morocco on `2025/10/25 9:04 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/mowgly11">
				<img src="https://avatars.githubusercontent.com/u/83482871?s=72&u=96a52c4912453ff91763737b953dbdc92f3ec8fa&v=4" width="24" alt="Avatar of mowgly11"> mowgly11
			</a><br/>
			John
		</td>
		<td>No Company</td>
