...
The `public contributions` and `private contributions` by users in Morocco on `2026/2/20 5:35 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AnasFiguigui">
				<img src="https://avatars.githubusercontent.com/u/92400545?s=72&u=49c14bf4e5010526c75fe24ea9191496e3bd9895&v=4" width="24" alt="Avatar of AnasFiguigui"> AnasFiguigui
			</a><br/>
			Anas
		</td>
		<td>No Company</td>
