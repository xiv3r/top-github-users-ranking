...
The `public contributions` and `private contributions` by users in Philippines on `2025/7/22 7:57 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
