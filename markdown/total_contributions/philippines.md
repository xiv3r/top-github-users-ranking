...
The `public contributions` and `private contributions` by users in Philippines on `2025/11/2 4:41 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
