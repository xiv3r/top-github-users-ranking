...
The `public contributions` and `private contributions` by users in Mali on `2025/1/19 1:51 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `485 users`  in Mali. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>105</td>
		<td>
			<a href="https://github.com/Traore696">
				<img src="https://avatars.githubusercontent.com/u/184234710?s=72&v=4" width="24" alt="Avatar of Traore696"> Traore696
			</a><br/>
			Aissata TRAORE 
		</td>
		<td>No Company</td>
