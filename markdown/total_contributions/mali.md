...
The `public contributions` and `private contributions` by users in Mali on `2025/4/18 10:59 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
