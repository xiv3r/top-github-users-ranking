...
The `public contributions` and `private contributions` by users in Mali on `2026/2/28 5:59 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `632 users`  in Mali. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>280</td>
		<td>
			<a href="https://github.com/Ad140786">
				<img src="https://avatars.githubusercontent.com/u/200860611?s=72&v=4" width="24" alt="Avatar of Ad140786"> Ad140786
			</a><br/>
			Diallo Adama
		</td>
		<td>Quincaillerie Et Friperie Générale<br/></td>
		<td>No Twitter Username</td>
		<td>Bamako</td>
		<td>1</td>
		<td>1</td>
