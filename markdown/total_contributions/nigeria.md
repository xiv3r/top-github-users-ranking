...
The `public contributions` and `private contributions` by users in Nigeria on `2025/9/29 9:45 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/davepatty5686">davepatty5686</a></td>
		<td>Lagos, Nigeria</td>
		<td>1103</td>
		<td>5674</td>
	</tr>
