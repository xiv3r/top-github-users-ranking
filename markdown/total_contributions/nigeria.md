...
The `public contributions` and `private contributions` by users in Nigeria on `2025/5/26 10:01 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/soy_maddiie">soy_maddiie</a></td>
		<td>Nigeria</td>
		<td>62</td>
		<td>62</td>
	</tr>
