...
The `public contributions` and `private contributions` by users in Nigeria on `2025/8/3 5:21 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
