...
The `public contributions` and `private contributions` by users in Nigeria on `2025/2/19 1:50 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
