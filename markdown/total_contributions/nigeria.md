...
The `public contributions` and `private contributions` by users in Nigeria on `2025/6/11 11:03 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
