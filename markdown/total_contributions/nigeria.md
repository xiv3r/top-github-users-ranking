...
The `public contributions` and `private contributions` by users in Nigeria on `2025/10/23 9:50 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/FunmiiRs">FunmiiRs</a></td>
		<td>Lagos, Nigeria </td>
		<td>199</td>
		<td>619</td>
	</tr>
