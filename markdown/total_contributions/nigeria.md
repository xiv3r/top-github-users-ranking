...
The `public contributions` and `private contributions` by users in Nigeria on `2025/11/13 6:08 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
