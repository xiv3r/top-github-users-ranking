...
The `public contributions` and `private contributions` by users in Nigeria on `2025/10/14 10:57 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/gdd3v">gdd3v</a></td>
		<td>Lagos, Nigeria</td>
		<td>304</td>
		<td>1657</td>
	</tr>
