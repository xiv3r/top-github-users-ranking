...
The `public contributions` and `private contributions` by users in Nigeria on `2026/2/13 8:13 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
