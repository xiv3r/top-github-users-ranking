...
The `public contributions` and `private contributions` by users in Nigeria on `2026/1/25 3:38 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
