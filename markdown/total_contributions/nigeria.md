...
The `public contributions` and `private contributions` by users in Nigeria on `2025/6/14 4:06 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
