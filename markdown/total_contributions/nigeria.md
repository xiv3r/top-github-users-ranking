...
The `public contributions` and `private contributions` by users in Nigeria on `2025/9/23 5:58 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
...
<table>
	...
	<tr>
		...
		<td>@github </td>
		<td><a href="https://twitter.com/ayokanmiqdejola">ayokanmiqdejola</a></td>
		<td>Lagos, Nigeria</td>
		<td>1659</td>
		<td>1729</td>
	</tr>
