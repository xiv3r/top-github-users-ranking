...
The `public contributions` and `private contributions` by users in Nigeria on `2025/1/7 8:51 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
