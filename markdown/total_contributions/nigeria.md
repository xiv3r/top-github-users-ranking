...
The `public contributions` and `private contributions` by users in Nigeria on `2025/9/4 8:42 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
