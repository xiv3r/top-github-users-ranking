...
The `public contributions` and `private contributions` by users in Nigeria on `2025/10/28 7:51 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `994 users`  in Nigeria. You need at least `74 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/favor-ui">
				<img src="https://avatars.githubusercontent.com/u/54090534?s=72&u=e773d9886c81afe22e450b888ceaa286a1a95584&v=4" width="24" alt="Avatar of favor-ui"> favor-ui
			</a><br/>
			Garose Choji
		</td>
		<td>No Company</td>
