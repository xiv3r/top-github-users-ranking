...
The `public contributions` and `private contributions` by users in Iceland on `2025/11/12 11:51 PM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.
...
<table>
	...
	<tr>
		...
		<td>Infocapital - @blikk-software <br/></td>
	...
	<tr>
		<td>532</td>
		<td>
			<a href="https://github.com/einarorn">
				<img src="https://avatars.githubusercontent.com/u/19308179?s=72&u=2aec24396e78f0d6ccaa1d6acf745ba59e474659&v=4" width="24" alt="Avatar of einarorn"> einarorn
			</a><br/>
			Einar Olafsson
		</td>
		<td>@opus-futura </td>
