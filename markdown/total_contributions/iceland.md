...
The `public contributions` and `private contributions` by users in Iceland on `2026/3/15 10:12 AM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `876 users`  in Iceland. You need at least `3 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>618</td>
		<td>
			<a href="https://github.com/sjonni1">
				<img src="https://avatars.githubusercontent.com/u/662525?s=72&v=4" width="24" alt="Avatar of sjonni1"> sjonni1
			</a><br/>
			Sjonni
		</td>
		<td>Paxflow </td>
