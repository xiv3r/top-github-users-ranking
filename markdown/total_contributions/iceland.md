...
The `public contributions` and `private contributions` by users in Iceland on `2025/2/12 1:10 AM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `891 users`  in Iceland. You need at least `3 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>409</td>
		<td>
			<a href="https://github.com/skufsi">
				<img src="https://avatars.githubusercontent.com/u/57811894?s=72&u=554bb94cc2aae20ed8f5ff93cb30044f30cad88e&v=4" width="24" alt="Avatar of skufsi"> skufsi
			</a><br/>
			Anton Björn Árnason
		</td>
		<td>No Company</td>
