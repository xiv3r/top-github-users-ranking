...
The `public contributions` and `private contributions` by users in Iceland on `2025/2/17 6:56 AM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.
