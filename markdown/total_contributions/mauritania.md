...
The `public contributions` and `private contributions` by users in Mauritania on `2025/10/19 5:02 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
