...
The `public contributions` and `private contributions` by users in Mauritania on `2026/8/13 1:59 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
