...
The `public contributions` and `private contributions` by users in Mauritania on `2025/11/8 5:40 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
