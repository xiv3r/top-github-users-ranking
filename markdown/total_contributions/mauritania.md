...
The `public contributions` and `private contributions` by users in Mauritania on `2026/7/21 8:00 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
