...
The `public contributions` and `private contributions` by users in Iran on `2025/1/11 11:22 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/MatinAfzal">
				<img src="https://avatars.githubusercontent.com/u/128434167?s=72&u=3a4b9ba2618b88705d793a4a52eabe43105bd32a&v=4" width="24" alt="Avatar of MatinAfzal"> MatinAfzal
			</a><br/>
			Matin
		</td>
		<td>No Company</td>
