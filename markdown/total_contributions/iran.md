...
The `public contributions` and `private contributions` by users in Iran on `2025/2/15 2:10 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tahamajs">
				<img src="https://avatars.githubusercontent.com/u/108874557?s=72&u=2cdae887cf9b133f498b7a55b00434a9a8de025e&v=4" width="24" alt="Avatar of tahamajs"> tahamajs
			</a><br/>
			Taha Majlesi
		</td>
		<td>University Of Tehran </td>
