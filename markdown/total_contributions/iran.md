...
The `public contributions` and `private contributions` by users in Iran on `2025/1/25 5:21 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
