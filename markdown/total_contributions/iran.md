...
The `public contributions` and `private contributions` by users in Iran on `2025/2/17 7:41 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tahamajs">
				<img src="https://avatars.githubusercontent.com/u/108874557?s=72&u=23d3b7b396616e6e7f65501f61f425746e91c7b5&v=4" width="24" alt="Avatar of tahamajs"> tahamajs
			</a><br/>
			Taha Majlesi
		</td>
		<td>University Of Tehran </td>
