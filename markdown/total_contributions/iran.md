...
The `public contributions` and `private contributions` by users in Iran on `2025/2/15 2:00 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
