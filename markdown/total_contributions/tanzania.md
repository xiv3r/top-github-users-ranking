...
The `public contributions` and `private contributions` by users in Tanzania on `2025/10/17 6:38 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
