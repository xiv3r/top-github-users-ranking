...
The `public contributions` and `private contributions` by users in Tanzania on `2025/11/4 7:03 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
