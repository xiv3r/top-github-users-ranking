...
The `public contributions` and `private contributions` by users in Tanzania on `2025/5/20 8:05 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
