...
The `public contributions` and `private contributions` by users in Tanzania on `2025/12/24 11:54 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
