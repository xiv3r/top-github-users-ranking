...
The `public contributions` and `private contributions` by users in Tanzania on `2026/1/6 11:44 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
