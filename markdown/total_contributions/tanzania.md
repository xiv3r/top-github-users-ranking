...
The `public contributions` and `private contributions` by users in Tanzania on `2025/5/25 9:01 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
