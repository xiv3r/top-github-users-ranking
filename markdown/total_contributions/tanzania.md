...
The `public contributions` and `private contributions` by users in Tanzania on `2025/11/25 9:54 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
