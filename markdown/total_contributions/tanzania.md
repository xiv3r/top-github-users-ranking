...
The `public contributions` and `private contributions` by users in Tanzania on `2024/12/31 5:04 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
