...
The `public contributions` and `private contributions` by users in Tanzania on `2025/8/31 7:44 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
