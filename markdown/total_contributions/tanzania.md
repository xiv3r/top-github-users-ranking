...
The `public contributions` and `private contributions` by users in Tanzania on `2025/7/13 2:33 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
