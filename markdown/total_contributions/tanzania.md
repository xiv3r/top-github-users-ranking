...
The `public contributions` and `private contributions` by users in Tanzania on `2025/8/1 8:47 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
