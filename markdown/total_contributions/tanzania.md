...
The `public contributions` and `private contributions` by users in Tanzania on `2025/9/5 11:01 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
