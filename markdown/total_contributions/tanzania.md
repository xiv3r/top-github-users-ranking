...
The `public contributions` and `private contributions` by users in Tanzania on `2025/1/8 8:46 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
