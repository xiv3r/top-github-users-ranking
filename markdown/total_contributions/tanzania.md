...
The `public contributions` and `private contributions` by users in Tanzania on `2025/6/21 5:44 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
