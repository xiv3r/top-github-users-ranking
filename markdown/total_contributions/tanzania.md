...
The `public contributions` and `private contributions` by users in Tanzania on `2025/6/5 11:58 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
