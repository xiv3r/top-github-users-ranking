...
The `public contributions` and `private contributions` by users in Tanzania on `2025/3/2 3:09 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
