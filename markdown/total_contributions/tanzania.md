...
The `public contributions` and `private contributions` by users in Tanzania on `2025/1/25 11:25 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
