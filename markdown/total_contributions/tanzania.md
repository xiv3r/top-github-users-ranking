...
The `public contributions` and `private contributions` by users in Tanzania on `2025/10/8 11:02 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
