...
The `public contributions` and `private contributions` by users in Tanzania on `2026/2/22 2:05 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
