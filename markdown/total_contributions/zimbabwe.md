...
The `public contributions` and `private contributions` by users in Zimbabwe on `2025/10/13 12:33 PM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `913 users`  in Zimbabwe. You need at least `2 followers` to be on this list.
