...
The `public contributions` and `private contributions` by users in Burkina Faso on `2026/5/28 4:20 PM UTC`. This list contains users from `Burkina Faso` and cities `Ouagadougou` `Bobo-dioulasso` `Koudougou` `Banfora` `Ouahigouya`.
