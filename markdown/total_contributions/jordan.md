...
The `public contributions` and `private contributions` by users in Jordan on `2025/3/5 8:04 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
