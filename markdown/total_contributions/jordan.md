...
The `public contributions` and `private contributions` by users in Jordan on `2026/3/7 7:03 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
