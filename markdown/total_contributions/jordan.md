...
The `public contributions` and `private contributions` by users in Jordan on `2026/1/17 5:48 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Tareq-Bilal">
				<img src="https://avatars.githubusercontent.com/u/149328700?s=72&u=19ef7f5a2ff634697fd8dff52b9be35bb7a13af2&v=4" width="24" alt="Avatar of Tareq-Bilal"> Tareq-Bilal
			</a><br/>
			Tareq Abu Sharkh
		</td>
