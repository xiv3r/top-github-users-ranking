...
The `public contributions` and `private contributions` by users in Jordan on `2025/11/17 6:47 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/xiv3r/top-github-users-ranking).

There are `970 users`  in Jordan. You need at least `9 followers` to be on this list.
