...
The `public contributions` and `private contributions` by users in Jordan on `2025/8/25 5:22 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
