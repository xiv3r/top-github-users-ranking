...
The `public contributions` and `private contributions` by users in Jordan on `2025/5/12 4:08 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/itsmutasem">
				<img src="https://avatars.githubusercontent.com/u/143445025?s=72&u=763e568f9fc2fc02125143b9a47453d7542585ea&v=4" width="24" alt="Avatar of itsmutasem"> itsmutasem
			</a><br/>
			Mutasem Mustafa
		</td>
		<td>No Company</td>
