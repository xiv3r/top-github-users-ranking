...
The `public contributions` and `private contributions` by users in Jordan on `2026/7/20 5:07 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
