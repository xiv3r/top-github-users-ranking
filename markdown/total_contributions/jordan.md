...
The `public contributions` and `private contributions` by users in Jordan on `2025/2/3 8:46 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
