...
The `public contributions` and `private contributions` by users in Jordan on `2025/5/17 4:22 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/dev3k">
				<img src="https://avatars.githubusercontent.com/u/241731?s=72&u=bc6f8325e2daf843d3dc23d3edf1c51076e973cd&v=4" width="24" alt="Avatar of dev3k"> dev3k
			</a><br/>
			Khalil Majdalawi
		</td>
		<td>No Company</td>
