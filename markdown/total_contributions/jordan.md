...
The `public contributions` and `private contributions` by users in Jordan on `2026/6/21 5:10 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
