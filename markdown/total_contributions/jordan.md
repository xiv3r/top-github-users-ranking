...
The `public contributions` and `private contributions` by users in Jordan on `2025/4/29 10:34 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
