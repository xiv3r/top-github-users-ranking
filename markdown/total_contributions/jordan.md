...
The `public contributions` and `private contributions` by users in Jordan on `2025/8/28 6:47 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
