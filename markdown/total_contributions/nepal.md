...
The `public contributions` and `private contributions` by users in Nepal on `2025/1/17 8:51 PM UTC`. This list contains users from `Nepal` and cities `Kathmandu` `Pokhara` `Lalitpur` `Bharatpur` `Biratnagar` `Birgunj` `Janakpur` `Hetauda`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/anishregmi17">
				<img src="https://avatars.githubusercontent.com/u/103883548?s=72&u=c9517eb3391218dcd178bdabdc112b31d3792161&v=4" width="24" alt="Avatar of anishregmi17"> anishregmi17
			</a><br/>
			Anish Regmi 
		</td>
