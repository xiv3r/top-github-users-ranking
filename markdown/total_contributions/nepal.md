...
The `public contributions` and `private contributions` by users in Nepal on `2025/11/22 9:52 PM UTC`. This list contains users from `Nepal` and cities `Kathmandu` `Pokhara` `Lalitpur` `Bharatpur` `Biratnagar` `Birgunj` `Janakpur` `Hetauda`.
...
<table>
	...
	<tr>
		...
		<td>No Twitter Username</td>
		<td>B.P. Marga, Pokhara 33700, Nepal</td>
		<td>28</td>
		<td>3109</td>
	</tr>
	<tr>
