...
The `public contributions` and `private contributions` by users in Spain on `2025/12/21 3:39 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/danywalls">
				<img src="https://avatars.githubusercontent.com/u/5494535?s=72&u=2c9b50bde4170c06731c2e7002d05d5ddb948220&v=4" width="24" alt="Avatar of danywalls"> danywalls
			</a><br/>
			Dany Paredes
		</td>
		<td>No Company</td>
