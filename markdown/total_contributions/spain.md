...
The `public contributions` and `private contributions` by users in Spain on `2025/2/26 11:08 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/juanmicl">
				<img src="https://avatars.githubusercontent.com/u/19253629?s=72&u=8d3513ada6426a7c7b52621dac45760a9bd9b2d3&v=4" width="24" alt="Avatar of juanmicl"> juanmicl
			</a><br/>
			Juan Miguel C.
		</td>
		<td>No Company</td>
