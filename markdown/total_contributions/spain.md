...
The `public contributions` and `private contributions` by users in Spain on `2025/8/1 5:55 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
