...
The `public contributions` and `private contributions` by users in Spain on `2025/7/13 12:02 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Beelzenef">
				<img src="https://avatars.githubusercontent.com/u/6389665?s=72&u=6ea24b31a6029315b4e84eea21ce147c3d8736e6&v=4" width="24" alt="Avatar of Beelzenef"> Beelzenef
			</a><br/>
			Elena
		</td>
		<td>Devoteam </td>
