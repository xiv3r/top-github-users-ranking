...
The `public contributions` and `private contributions` by users in Spain on `2026/2/22 8:04 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
...
<table>
	...
	<tr>
		<td>750</td>
		<td>
			<a href="https://github.com/aspirinoo">
				<img src="https://avatars.githubusercontent.com/u/46905499?s=72&u=aa61cb78cecc4dc4c60aee0ab2762d1ba51b81ff&v=4" width="24" alt="Avatar of aspirinoo"> aspirinoo
			</a><br/>
			aspirino
		</td>
		<td>No Company</td>
