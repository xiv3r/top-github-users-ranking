...
The `public contributions` and `private contributions` by users in Spain on `2025/11/18 5:10 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/R0rt1z2">
				<img src="https://avatars.githubusercontent.com/u/39171306?s=72&u=5e0b2d5d794571b8b0aa1c06f541145ea56e43cd&v=4" width="24" alt="Avatar of R0rt1z2"> R0rt1z2
			</a><br/>
			Roger Ortiz
		</td>
		<td>No Company</td>
	...
	<tr>
		...
		<td><a href="https://twitter.com/Sabi_SLTI">Sabi_SLTI</a></td>
		<td>Spain</td>
		<td>4</td>
		<td>2573</td>
	</tr>
