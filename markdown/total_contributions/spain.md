...
The `public contributions` and `private contributions` by users in Spain on `2025/12/16 7:12 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
...
<table>
	...
	<tr>
		<td>840</td>
		<td>
			<a href="https://github.com/txfol">
				<img src="https://avatars.githubusercontent.com/u/163127943?s=72&u=20dda12031369e94ab709280a5db0f1e41c42bb9&v=4" width="24" alt="Avatar of txfol"> txfol
			</a><br/>
			TxFoL
		</td>
		<td>No Company</td>
