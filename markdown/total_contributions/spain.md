...
The `public contributions` and `private contributions` by users in Spain on `2025/7/29 1:25 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
