...
The `public contributions` and `private contributions` by users in Spain on `2026/1/26 1:22 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/alvarobartt">
				<img src="https://avatars.githubusercontent.com/u/36760800?s=72&u=6aed921e83837d34382c40f686fc376a75edb900&v=4" width="24" alt="Avatar of alvarobartt"> alvarobartt
			</a><br/>
			Alvaro Bartolome
		</td>
		<td>@huggingface </td>
