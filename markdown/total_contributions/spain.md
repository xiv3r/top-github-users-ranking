...
The `public contributions` and `private contributions` by users in Spain on `2025/4/27 8:36 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
