...
The `public contributions` and `private contributions` by users in Spain on `2026/8/23 8:05 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
