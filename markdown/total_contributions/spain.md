...
The `public contributions` and `private contributions` by users in Spain on `2025/6/16 12:11 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/CKGrafico">
				<img src="https://avatars.githubusercontent.com/u/2048511?s=72&u=d600cda5871868bf5b89e6b00b61900a597aa5d2&v=4" width="24" alt="Avatar of CKGrafico"> CKGrafico
			</a><br/>
			Quique Fdez Guerra
		</td>
		<td>@plainconcepts </td>
