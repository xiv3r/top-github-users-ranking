...
The `public contributions` and `private contributions` by users in Spain on `2025/5/10 7:02 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/fmartingr">
				<img src="https://avatars.githubusercontent.com/u/812088?s=72&u=652124cdcb75a8d40153e50740fe73dc6c8411c4&v=4" width="24" alt="Avatar of fmartingr"> fmartingr
			</a><br/>
			Felipe Martin
		</td>
		<td>@mattermost </td>
