...
The `public contributions` and `private contributions` by users in Spain on `2025/10/26 10:45 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
