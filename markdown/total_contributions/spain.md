...
The `public contributions` and `private contributions` by users in Spain on `2025/8/26 2:45 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
...
<table>
	...
	<tr>
		<td>433</td>
		<td>
			<a href="https://github.com/hcosta">
				<img src="https://avatars.githubusercontent.com/u/748822?s=72&u=2599d5950997c326326e81bdb072db5f3834dd4b&v=4" width="24" alt="Avatar of hcosta"> hcosta
			</a><br/>
			Hektor
		</td>
		<td>No Company</td>
	...
	<tr>
		...
		<td>Blockchain </td>
		<td><a href="https://twitter.com/bigfrankykevin">bigfrankykevin</a></td>
