...
The `public contributions` and `private contributions` by users in Spain on `2025/12/10 10:13 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
