...
The `public contributions` and `private contributions` by users in Spain on `2025/12/29 3:04 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/fxn">
				<img src="https://avatars.githubusercontent.com/u/3387?s=72&u=6e6448f5add2f6c707a5f16d29dc49899bef9f58&v=4" width="24" alt="Avatar of fxn"> fxn
			</a><br/>
			Xavier Noria
		</td>
		<td>Freelance </td>
