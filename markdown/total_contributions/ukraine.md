...
The `public contributions` and `private contributions` by users in Ukraine on `2025/10/13 8:46 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
