...
The `public contributions` and `private contributions` by users in Ukraine on `2025/10/15 2:11 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
